...
class AdapterTests(unittest.TestCase):
    ...
    def test_skidl_generator_is_deterministic_and_complete(self):
        ...
        self.assertEqual(
            tuple(inspect.signature(generate_skidl).parameters),
            ("spec", "include_netlist", "catalog_receipt_sha256"),
        )
        self.assertEqual(source, generate_skidl(spec))
        self.assertEqual(
            source,
            """# Generated by pcbex Text-to-Circuit; do not edit by hand.
from skidl import Net, Part, generate_netlist

_PCBEX_MPN_BY_REFERENCE = {}

_pcbex_nets = {}
_pcbex_parts = {}

_pcbex_nets["GND"] = Net("GND")
_pcbex_nets["VCC"] = Net("VCC")

_pcbex_parts["R1"] = Part("Device", "R", value="10k", footprint="0402")
_pcbex_parts["U1"] = Part("Connector_Generic", "Conn_01x02", value="JTAG", footprint="PinHeader_1x02_P2.54mm_Vertical")

_pcbex_parts["R1"]["2"] += _pcbex_nets["GND"]
_pcbex_parts["U1"]["2"] += _pcbex_nets["GND"]
_pcbex_parts["R1"]["1"] += _pcbex_nets["VCC"]
_pcbex_parts["U1"]["1"] += _pcbex_nets["VCC"]
