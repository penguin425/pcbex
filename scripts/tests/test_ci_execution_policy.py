...
class CiExecutionPolicyTests(unittest.TestCase):
    ...
    def test_shared_runtime_boundaries_run_on_macos_and_windows(self):
        ...
        self.assertLess(
            ...
            rust_windows.index(
                "- name: Run Windows v1.485-v1.527 factory-state transparency boundaries"
            ),
        )
        ...
        factory_state_transparency_step = boundaries.index(
            "- name: Run cross-platform v1.485-v1.527 factory-state transparency boundaries"
        )
        ...
        organization_registry_step = boundaries.index(
            "- name: Run cross-platform v1.493-v1.527 organization-registry ledger boundaries"
        )
