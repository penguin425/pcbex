...
The next roadmap should add dual-quorum approval-gossip governance rotation,
so authority membership, keys, and thresholds can change without weakening
the retained governance boundary.
