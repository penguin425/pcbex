...
The next roadmap should add threshold governance for the approval-gossip
registry, so no single registry authority can admit, suspend, or revoke an
organization without a distinct-key quorum.
