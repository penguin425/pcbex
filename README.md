...
| Final receipt-quorum checkpoint-witness receipt transparency v1 | Normalize one canonical v1.526 receipt into the existing signed, anchored, consistency-proved, gossiped, and witnessed approval-log chain | [Final-checkpoint receipt transparency guide](docs/FACTORY_RELEASE_FINAL_CHECKPOINT_WITNESS_RECEIPT_QUORUM_CHECKPOINT_WITNESS_RECEIPT_TRANSPARENCY.md) |
| Verifier-bound final receipt-quorum checkpoint-witness receipt admission v1 | Replay the exact v1.521 report/log, v1.523 checkpoint, v1.524 response, identity, freshness, and direct or current v1.525 trust before immutable append | [Final-checkpoint receipt admission guide](docs/FACTORY_RELEASE_FINAL_CHECKPOINT_WITNESS_RECEIPT_QUORUM_CHECKPOINT_WITNESS_RECEIPT_ADMISSION.md) |
