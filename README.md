...
and end immediately afterward; the class name must not be blank, and trailing
condition fragments are rejected rather than partially applied. Only direct
`A.NetClass` or `B.NetClass` selectors are interpreted; compound conditions
