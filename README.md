...
non-negative, signed-nanometer range contract. Their names must also be unique;
duplicate embedded definitions are rejected instead of silently selecting the
last one.
