...
Board segments and routed arcs with a nonzero net ID must likewise reference a
declared net; stale routed copper is rejected instead of creating an ownerless
route candidate.
