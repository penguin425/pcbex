...
fn publishes_a_complete_versioned_capability_inventory() {
    ...
    for name in [
        ...
        "signed-remote-factory-release-final-checkpoint-witness-receipt-quorum-log-checkpoint-schema",
        "remote-factory-release-final-checkpoint-witness-receipt-quorum-log-checkpoint-verification-schema",
        "validate-signed-remote-factory-release-final-checkpoint-witness-receipt-quorum-log-checkpoint",
        "sign-remote-factory-release-final-checkpoint-witness-receipt-quorum-log-checkpoint",
        "verify-remote-factory-release-final-checkpoint-witness-receipt-quorum-log-checkpoint",
        "signed-remote-factory-release-final-checkpoint-witness-receipt-quorum-log-checkpoint-witness-schema",
        ...
        "remote-factory-release-final-checkpoint-witness-receipt-quorum-log-checkpoint-witness-receipt-quorum-report-schema",
        "validate-remote-factory-release-final-checkpoint-witness-receipt-quorum-log-checkpoint-witness-receipt-quorum-report",
        ...
        "validate-remote-factory-release-final-checkpoint-witness-receipt-quorum-log-checkpoint-witness-trust-state",
        "signed-remote-factory-release-final-checkpoint-witness-receipt-quorum-log-checkpoint-witness-key-rotation-schema",
        "validate-signed-remote-factory-release-final-checkpoint-witness-receipt-quorum-log-checkpoint-witness-key-rotation",
        "witness-remote-factory-release-final-checkpoint-witness-receipt-quorum-log-checkpoint",
        "request-remote-factory-release-final-checkpoint-witness-receipt-quorum-log-checkpoint-witness",
        ...
        "remote-factory-release-final-checkpoint-witness-receipt-quorum-log-checkpoint-witness-quorum-manifest-schema",
        "validate-remote-factory-release-final-checkpoint-witness-receipt-quorum-log-checkpoint-witness-quorum-manifest",
        "remote-factory-release-final-checkpoint-witness-receipt-quorum-log-checkpoint-witness-quorum-acquisition-report-schema",
        "validate-remote-factory-release-final-checkpoint-witness-receipt-quorum-log-checkpoint-witness-quorum-acquisition-report",
        "request-remote-factory-release-final-checkpoint-witness-receipt-quorum-log-checkpoint-witness-quorum",
