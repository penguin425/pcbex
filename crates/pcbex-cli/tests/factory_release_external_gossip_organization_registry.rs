...
fn exports_and_independently_audits_complete_five_kind_registry_history() {
    ...
    let final_checkpoint_witness_a_secret =
        root.join("checkpoint-witness-receipt-quorum-checkpoint-witness-a-secret.hex");
    let final_checkpoint_witness_a_public =
        root.join("checkpoint-witness-receipt-quorum-checkpoint-witness-a-public.hex");
    let final_checkpoint_witness_b_secret =
        root.join("checkpoint-witness-receipt-quorum-checkpoint-witness-b-secret.hex");
    let final_checkpoint_witness_b_public =
        root.join("checkpoint-witness-receipt-quorum-checkpoint-witness-b-public.hex");
    let final_checkpoint_witness_a_next_secret =
        root.join("checkpoint-witness-receipt-quorum-checkpoint-witness-a-next-secret.hex");
    let final_checkpoint_witness_a_next_public =
        root.join("checkpoint-witness-receipt-quorum-checkpoint-witness-a-next-public.hex");
    for (secret_path, public_path, secret) in [
        ...
        (
            &final_checkpoint_witness_a_secret,
            &final_checkpoint_witness_a_public,
            [88; 32],
        ),
        (
            &final_checkpoint_witness_b_secret,
            &final_checkpoint_witness_b_public,
            [89; 32],
        ),
        (
            &final_checkpoint_witness_a_next_secret,
            &final_checkpoint_witness_a_next_public,
            [90; 32],
        ),
    ] {
        write_hex(secret_path, secret, 0o600);
    ...
    let remote_checkpoint_witness_receipt_log_empty =
        root.join("registry-witness-receipts.remote-checkpoint-receipts.log.0.json");
    let remote_checkpoint_witness_receipt_log =
        root.join("registry-witness-receipts.remote-checkpoint-receipts.log.1.json");
    let remote_checkpoint_witness_receipt_log_checkpoint =
        root.join("registry-witness-receipts.remote-checkpoint-receipts.checkpoint.json");
    let remote_checkpoint_witness_receipt_log_verification =
        root.join("registry-witness-receipts.remote-checkpoint-receipts.verification.json");
    successful(&[
        "init-approval-log",
        "--log-id",
        "factory-receipt-quorum-checkpoint-witness-receipts",
        "--output",
    ...
    let remote_checkpoint_witness_receipt_event =
        &remote_checkpoint_witness_receipt_log_value["entries"][0]["event"];
    assert_eq!(
        remote_checkpoint_witness_receipt_event["artifact_kind"],
        "remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt"
    );
    assert_eq!(
        remote_checkpoint_witness_receipt_event["artifact_sha256"],
        hex::encode(Sha256::digest(compact_json_source(
            &remote_dedicated_checkpoint_witness_b_receipt_source
        )))
    );
    assert_eq!(
        remote_checkpoint_witness_receipt_event["subject_id"],
        remote_dedicated_checkpoint_witness_b_receipt_value["checkpoint_sha256"]
    );
    assert_eq!(
        remote_checkpoint_witness_receipt_event["request_sha256"],
        remote_dedicated_checkpoint_witness_b_receipt_value["request_sha256"]
    );
    assert_eq!(
        remote_checkpoint_witness_receipt_event["session_sha256"],
        remote_dedicated_checkpoint_witness_b_receipt_value["response_sha256"]
    );
    assert_eq!(
        remote_checkpoint_witness_receipt_event["signer_id"],
        Value::Null
    );
    assert_eq!(
        remote_checkpoint_witness_receipt_event["outcome"],
        "verified-witness:independent-factory-witness-b"
    );
    successful(&[
        "sign-approval-log",
        path(&remote_checkpoint_witness_receipt_log),
        "--private-key",
        path(&receipt_quorum_checkpoint_witness_b_secret),
        "--signer-id",
        "factory-receipt-quorum-checkpoint-witness-receipt-log",
        "--output",
        path(&remote_checkpoint_witness_receipt_log_checkpoint),
    ]);
    successful(&[
        "verify-approval-log",
        path(&remote_checkpoint_witness_receipt_log),
        ...
        path(&receipt_quorum_checkpoint_witness_b_public),
        "--output",
        path(&remote_checkpoint_witness_receipt_log_verification),
    ]);
    assert_eq!(
        serde_json::from_slice::<Value>(
            &fs::read(&remote_checkpoint_witness_receipt_log_verification).unwrap()
        )
        .unwrap()["verified"],
        true
    );

    let mut rejected_remote_checkpoint_witness_receipt_value =
        remote_dedicated_checkpoint_witness_b_receipt_value.clone();
    rejected_remote_checkpoint_witness_receipt_value["verified"] = false.into();
    let rejected_remote_checkpoint_witness_receipt =
        root.join("registry-witness-receipts.remote-checkpoint-receipt.rejected.json");
    let rejected_remote_checkpoint_witness_receipt_log =
        root.join("registry-witness-receipts.remote-checkpoint-receipts.rejected-log.json");
    write_canonical_json(
        &rejected_remote_checkpoint_witness_receipt,
        &rejected_remote_checkpoint_witness_receipt_value,
    );
    let rejected = run(&[
        "append-approval-log",
        path(&remote_checkpoint_witness_receipt_log),
        "--artifact",
        path(&rejected_remote_checkpoint_witness_receipt),
        "--kind",
        "remote-factory-release-registry-history-receipt-quorum-log-checkpoint-witness-receipt",
        "--recorded-at-unix",
        "5602",
        "--output",
        path(&rejected_remote_checkpoint_witness_receipt_log),
    ]);
    assert!(!rejected.status.success());
    assert!(!rejected_remote_checkpoint_witness_receipt_log.exists());
    ...
    let remote_dedicated_checkpoint_witness_a_direct =
        root.join("registry-witness-receipts.dedicated-checkpoint.witness-a.remote-direct.json");
    let remote_dedicated_checkpoint_witness_a_direct_receipt = root.join(
        "registry-witness-receipts.dedicated-checkpoint.witness-a.remote-direct.receipt.json",
    );
    let (endpoint, server) = serve_json_once_at(
        fs::read(&dedicated_checkpoint_witness_a_rotated).unwrap(),
        None,
    ...
    successful(&[
        ...
        "5600",
        "--output",
        path(&remote_dedicated_checkpoint_witness_a_direct),
        "--receipt-output",
        path(&remote_dedicated_checkpoint_witness_a_direct_receipt),
        "--allow-http-loopback",
    ]);
    server.join().unwrap();

    let checkpoint_witness_receipt_quorum_log =
        root.join("registry-witness-receipts.remote-checkpoint-receipts.log.quorum.json");
    let checkpoint_witness_receipt_quorum_report =
        root.join("registry-witness-receipts.remote-checkpoint-receipts.quorum.json");
    successful(&[
    ...
    let checkpoint_witness_receipt_quorum_log_value: Value =
        serde_json::from_slice(&fs::read(&checkpoint_witness_receipt_quorum_log).unwrap()).unwrap();
    let checkpoint_witness_receipt_quorum_report_value: Value =
        serde_json::from_slice(&fs::read(&checkpoint_witness_receipt_quorum_report).unwrap())
            .unwrap();
    assert_eq!(
        checkpoint_witness_receipt_quorum_report_value["quorum_met"],
        true
    );
    assert_eq!(
        checkpoint_witness_receipt_quorum_report_value["valid_witnesses"],
        2
    );
    assert_eq!(
        checkpoint_witness_receipt_quorum_report_value["members"][0]["witness_id"],
        "independent-factory-witness-a"
    );
    assert_eq!(
        checkpoint_witness_receipt_quorum_report_value["members"][1]["witness_id"],
        "independent-factory-witness-b"
    );
    assert_eq!(
        checkpoint_witness_receipt_quorum_report_value["admission_log_id"],
        checkpoint_witness_receipt_quorum_log_value["log_id"]
    );
    assert_eq!(
        checkpoint_witness_receipt_quorum_report_value["admission_log_entry_count"],
        2
    );
    assert_eq!(
        checkpoint_witness_receipt_quorum_report_value["admission_log_head_sha256"],
        checkpoint_witness_receipt_quorum_log_value["head_sha256"]
    );
    assert_eq!(
        checkpoint_witness_receipt_quorum_report_value["admission_log_sha256"],
        hex::encode(Sha256::digest(compact_json_source(
            &fs::read(&checkpoint_witness_receipt_quorum_log).unwrap()
        )))
    );
    for index in 0..2 {
        let event = &checkpoint_witness_receipt_quorum_log_value["entries"][index]["event"];
        let member = &checkpoint_witness_receipt_quorum_report_value["members"][index];
        assert_eq!(
            event["artifact_kind"],
            "remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt"
        );
        assert_eq!(event["artifact_sha256"], member["receipt_sha256"]);
        assert_eq!(
            event["subject_id"],
            checkpoint_witness_receipt_quorum_report_value["checkpoint_sha256"]
        );
        assert_eq!(event["request_sha256"], member["request_sha256"]);
        assert_eq!(event["session_sha256"], member["response_sha256"]);
        assert_eq!(event["signer_id"], Value::Null);
        assert_eq!(
            event["outcome"],
            format!(
                "verified-witness:{}",
                member["witness_id"].as_str().unwrap()
            )
        );
    }

    let checkpoint_witness_receipt_quorum_schema =
        root.join("registry-witness-receipts.remote-checkpoint-receipts.quorum.schema.json");
    successful(&[
        "remote-factory-release-registry-history-receipt-quorum-log-checkpoint-witness-receipt-quorum-report-schema",
        "--output",
        path(&checkpoint_witness_receipt_quorum_schema),
    ]);
    assert_eq!(
        serde_json::from_slice::<Value>(
            &fs::read(&checkpoint_witness_receipt_quorum_schema).unwrap()
        )
        .unwrap()["additionalProperties"],
        false
    );
    let normalized_checkpoint_witness_receipt_quorum_report =
        root.join("registry-witness-receipts.remote-checkpoint-receipts.quorum.normalized.json");
    successful(&[
        "validate-remote-factory-release-registry-history-receipt-quorum-log-checkpoint-witness-receipt-quorum-report",
        path(&checkpoint_witness_receipt_quorum_report),
        "--output",
        path(&normalized_checkpoint_witness_receipt_quorum_report),
    ]);
    assert_eq!(
        fs::read(&normalized_checkpoint_witness_receipt_quorum_report).unwrap(),
        fs::read(&checkpoint_witness_receipt_quorum_report).unwrap()
    );

    let checkpoint_witness_receipt_quorum_bound_checkpoint = root
        .join("registry-witness-receipts.remote-checkpoint-receipts.quorum.bound-checkpoint.json");
    successful(&[
        ...
        path(&witness_a_next_secret),
        "--signer-id",
        "factory-checkpoint-witness-receipt-log",
        "--output",
        path(&checkpoint_witness_receipt_quorum_bound_checkpoint),
    ]);
    let generic_checkpoint_reference = root.join(
        "registry-witness-receipts.remote-checkpoint-receipts.quorum.generic-checkpoint.json",
    );
    successful(&[
        "sign-approval-log",
        path(&checkpoint_witness_receipt_quorum_log),
        ...
        "factory-checkpoint-witness-receipt-log",
        "--output",
        path(&generic_checkpoint_reference),
    ]);
    assert_eq!(
        fs::read(&checkpoint_witness_receipt_quorum_bound_checkpoint).unwrap(),
        fs::read(&generic_checkpoint_reference).unwrap()
    );
    let checkpoint_witness_receipt_quorum_bound_checkpoint_value: Value = serde_json::from_slice(
        &fs::read(&checkpoint_witness_receipt_quorum_bound_checkpoint).unwrap(),
    )
    .unwrap();
    assert_eq!(
        checkpoint_witness_receipt_quorum_bound_checkpoint_value["entry_count"],
        2
    );
    assert_eq!(
        checkpoint_witness_receipt_quorum_bound_checkpoint_value["log_sha256"],
        checkpoint_witness_receipt_quorum_report_value["admission_log_sha256"]
    );
    let checkpoint_witness_receipt_quorum_bound_verification = root.join(
        "registry-witness-receipts.remote-checkpoint-receipts.quorum.bound-verification.json",
    );
    successful(&[
        "verify-approval-log",
        path(&checkpoint_witness_receipt_quorum_log),
        ...
        path(&witness_a_next_public),
        "--output",
        path(&checkpoint_witness_receipt_quorum_bound_verification),
    ]);
    assert_eq!(
        serde_json::from_slice::<Value>(
            &fs::read(&checkpoint_witness_receipt_quorum_bound_verification).unwrap()
        )
        .unwrap()["verified"],
        true
    );

    let mismatched_checkpoint_witness_receipt_quorum_checkpoint = root.join(
        "registry-witness-receipts.remote-checkpoint-receipts.quorum.mismatched-checkpoint.json",
    );
    let checkpoint_witness_receipt_quorum_private_key_must_not_be_read =
        root.join("factory-checkpoint-witness-quorum-forbidden-missing.key");
    let mismatched_checkpoint_witness_receipt_quorum = run(&[
        "sign-approval-log-with-remote-factory-release-registry-history-receipt-quorum-log-checkpoint-witness-receipt-quorum",
        path(&remote_checkpoint_witness_receipt_log_empty),
        "--quorum-report",
        path(&checkpoint_witness_receipt_quorum_report),
        ...
        "factory-checkpoint-witness-receipt-log",
        "--output",
        path(&mismatched_checkpoint_witness_receipt_quorum_checkpoint),
    ]);
    assert!(
        !mismatched_checkpoint_witness_receipt_quorum
            .status
            .success()
    );
    let mismatched_checkpoint_witness_receipt_quorum_stderr =
        String::from_utf8_lossy(&mismatched_checkpoint_witness_receipt_quorum.stderr);
    assert!(
        mismatched_checkpoint_witness_receipt_quorum_stderr.contains(
            "does not match the remote factory release checkpoint-witness receipt quorum admission binding"
        ),
        "{mismatched_checkpoint_witness_receipt_quorum_stderr}"
    );
    ...
    let final_checkpoint_witness_a = root.join(
        "registry-witness-receipts.remote-checkpoint-receipts.quorum.dedicated-checkpoint.witness-a.json",
    );
    let final_checkpoint_witness_b = root.join(
        "registry-witness-receipts.remote-checkpoint-receipts.quorum.dedicated-checkpoint.witness-b.json",
    );
    for (private_key, witness_id, witnessed_at_unix, output) in [
        (
            &final_checkpoint_witness_a_secret,
            ...
            "5700",
            &final_checkpoint_witness_a,
        ),
        (
            &final_checkpoint_witness_b_secret,
            "checkpoint-receipt-quorum-witness-b",
            "5701",
            &final_checkpoint_witness_b,
        ),
    ] {
        successful(&[
    ...
    let final_checkpoint_witness_a_value: Value =
        serde_json::from_slice(&fs::read(&final_checkpoint_witness_a).unwrap()).unwrap();
    assert_eq!(
        final_checkpoint_witness_a_value["checkpoint_sha256"],
        hex::encode(Sha256::digest(compact_json_source(
            &fs::read(&dedicated_checkpoint_witness_receipt_quorum_checkpoint).unwrap()
        )))
    );
    assert_eq!(
        final_checkpoint_witness_a_value["receipt_quorum_checkpoint_sha256"],
        dedicated_checkpoint_witness_receipt_quorum_checkpoint_value["receipt_quorum_checkpoint_sha256"]
    );
    assert_eq!(
        final_checkpoint_witness_a_value["admission_log_sha256"],
        dedicated_checkpoint_witness_receipt_quorum_checkpoint_value["admission_log_sha256"]
    );

    let final_checkpoint_witness_schema = root.join(
        "registry-witness-receipts.remote-checkpoint-receipts.quorum.dedicated-checkpoint.witness.schema.json",
    );
    successful(&[
        ...
        "--output",
        path(&final_checkpoint_witness_schema),
    ]);
    assert_eq!(
        serde_json::from_slice::<Value>(&fs::read(&final_checkpoint_witness_schema).unwrap())
            .unwrap()["additionalProperties"],
        false
    );
    let normalized_final_checkpoint_witness = root.join(
        "registry-witness-receipts.remote-checkpoint-receipts.quorum.dedicated-checkpoint.witness-a.normalized.json",
    );
    successful(&[
        ...
        path(&final_checkpoint_witness_a),
        "--output",
        path(&normalized_final_checkpoint_witness),
    ]);
    assert_eq!(
        fs::read(&normalized_final_checkpoint_witness).unwrap(),
        fs::read(&final_checkpoint_witness_a).unwrap()
    );

    let final_checkpoint_witness_quorum = root.join(
        "registry-witness-receipts.remote-checkpoint-receipts.quorum.dedicated-checkpoint.witness-quorum.json",
    );
    successful(&[
        ...
        path(&witness_a_next_public),
        "--witnesses",
        path(&final_checkpoint_witness_b),
        "--witnesses",
        path(&final_checkpoint_witness_a),
        "--witness-public-keys",
        path(&final_checkpoint_witness_b_public),
        "--witness-public-keys",
        path(&final_checkpoint_witness_a_public),
        "--minimum-witnesses",
        "2",
        "--evaluated-at-unix",
        "5800",
        "--output",
        path(&final_checkpoint_witness_quorum),
    ]);
    let final_checkpoint_witness_quorum_value: Value =
        serde_json::from_slice(&fs::read(&final_checkpoint_witness_quorum).unwrap()).unwrap();
    assert_eq!(final_checkpoint_witness_quorum_value["quorum_met"], true);
    assert_eq!(final_checkpoint_witness_quorum_value["valid_witnesses"], 2);
    assert_eq!(
        final_checkpoint_witness_quorum_value["witness_ids"],
        serde_json::json!([
            "checkpoint-receipt-quorum-witness-a",
            "checkpoint-receipt-quorum-witness-b"
        ])
    ...
    assert_eq!(
        final_checkpoint_witness_quorum_value["checkpoint_sha256"],
        final_checkpoint_witness_a_value["checkpoint_sha256"]
    );

    let final_checkpoint_witness_a_initial_trust = root.join(
        "registry-witness-receipts.remote-checkpoint-receipts.quorum.dedicated-checkpoint.witness-a.initial.trust.json",
    );
    let final_checkpoint_witness_b_trust = root.join(
        "registry-witness-receipts.remote-checkpoint-receipts.quorum.dedicated-checkpoint.witness-b.trust.json",
    );
    for (witness_id, public_key, output) in [
        (
            "checkpoint-receipt-quorum-witness-a",
            &final_checkpoint_witness_a_public,
            &final_checkpoint_witness_a_initial_trust,
        ),
        (
            "checkpoint-receipt-quorum-witness-b",
            &final_checkpoint_witness_b_public,
            &final_checkpoint_witness_b_trust,
        ),
    ] {
        successful(&[
    ...
    let final_checkpoint_witness_a_initial_trust_value: Value =
        serde_json::from_slice(&fs::read(&final_checkpoint_witness_a_initial_trust).unwrap())
            .unwrap();
    assert_eq!(
        final_checkpoint_witness_a_initial_trust_value["generation"],
        0
    );
    assert_eq!(
        final_checkpoint_witness_a_initial_trust_value["last_rotation_sha256"],
        Value::Null
    );

    let final_checkpoint_witness_a_rotation = root.join(
        "registry-witness-receipts.remote-checkpoint-receipts.quorum.dedicated-checkpoint.witness-a.rotation.json",
    );
    successful(&[
        ...
        path(&final_checkpoint_witness_a_initial_trust),
        "--old-private-key",
        path(&final_checkpoint_witness_a_secret),
        "--new-private-key",
        path(&final_checkpoint_witness_a_next_secret),
        "--rotated-at-unix",
        "5650",
        "--output",
        path(&final_checkpoint_witness_a_rotation),
    ]);
    let final_checkpoint_witness_a_rotation_value: Value =
        serde_json::from_slice(&fs::read(&final_checkpoint_witness_a_rotation).unwrap()).unwrap();
    assert_eq!(
        final_checkpoint_witness_a_rotation_value["from_generation"],
        0
    );
    assert_eq!(
        final_checkpoint_witness_a_rotation_value["to_generation"],
        1
    );
    assert_eq!(
        final_checkpoint_witness_a_rotation_value["new_public_key"],
        fs::read_to_string(&final_checkpoint_witness_a_next_public)
            .unwrap()
            .trim()
    );

    let final_checkpoint_witness_a_rotated_trust = root.join(
        "registry-witness-receipts.remote-checkpoint-receipts.quorum.dedicated-checkpoint.witness-a.rotated.trust.json",
    );
    successful(&[
        ...
        path(&final_checkpoint_witness_a_rotation),
        "--output",
        path(&final_checkpoint_witness_a_rotated_trust),
    ]);
    let final_checkpoint_witness_a_rotated_trust_value: Value =
        serde_json::from_slice(&fs::read(&final_checkpoint_witness_a_rotated_trust).unwrap())
            .unwrap();
    assert_eq!(
        final_checkpoint_witness_a_rotated_trust_value["generation"],
        1
    );
    assert_eq!(
        final_checkpoint_witness_a_rotated_trust_value["last_rotation_sha256"],
        hex::encode(Sha256::digest(compact_json_source(
            &fs::read(&final_checkpoint_witness_a_rotation).unwrap()
        )))
    );

    let exported_final_checkpoint_witness_a_public = root.join(
        "registry-witness-receipts.remote-checkpoint-receipts.quorum.dedicated-checkpoint.witness-a.rotated.public.hex",
    );
    successful(&[
        ...
        path(&final_checkpoint_witness_a_rotated_trust),
        "--output",
        path(&exported_final_checkpoint_witness_a_public),
    ]);
    assert_eq!(
        fs::read(&exported_final_checkpoint_witness_a_public).unwrap(),
        fs::read(&final_checkpoint_witness_a_next_public).unwrap()
    );

    let final_checkpoint_witness_a_rotated = root.join(
        "registry-witness-receipts.remote-checkpoint-receipts.quorum.dedicated-checkpoint.witness-a.rotated.json",
    );
    successful(&[
        "witness-remote-factory-release-registry-history-receipt-quorum-log-checkpoint-witness-receipt-quorum-log-checkpoint",
        path(&checkpoint_witness_receipt_quorum_log),
        ...
        "5702",
        "--output",
        path(&final_checkpoint_witness_a_rotated),
    ]);
    let final_checkpoint_witness_rotated_quorum = root.join(
        "registry-witness-receipts.remote-checkpoint-receipts.quorum.dedicated-checkpoint.witness-quorum.rotated.json",
    );
    successful(&[
        "verify-remote-factory-release-registry-history-receipt-quorum-log-checkpoint-witness-receipt-quorum-log-checkpoint-witnesses",
        path(&checkpoint_witness_receipt_quorum_log),
        ...
        path(&final_checkpoint_witness_a_rotated_trust),
        "--witness-trust-states",
        path(&final_checkpoint_witness_b_trust),
        "--minimum-witnesses",
        "2",
        "--evaluated-at-unix",
        "5800",
        "--output",
        path(&final_checkpoint_witness_rotated_quorum),
    ]);
    assert_eq!(
        serde_json::from_slice::<Value>(
    ...
    for (witness, trust_state, suffix) in [
        (
            &final_checkpoint_witness_a,
            &final_checkpoint_witness_a_rotated_trust,
            "old-witness-current-trust",
        ),
        (
            &final_checkpoint_witness_a_rotated,
            &final_checkpoint_witness_a_initial_trust,
            "new-witness-stale-trust",
        ),
    ] {
        let rejected_output = root.join(format!(
            "registry-witness-receipts.remote-checkpoint-receipts.quorum.dedicated-checkpoint.witness-quorum.{suffix}.json"
        ));
        let rejected = run(&[
            "verify-remote-factory-release-registry-history-receipt-quorum-log-checkpoint-witness-receipt-quorum-log-checkpoint-witnesses",
            path(&checkpoint_witness_receipt_quorum_log),
    ...
    let final_checkpoint_witness_mixed_mode = root.join(
        "registry-witness-receipts.remote-checkpoint-receipts.quorum.dedicated-checkpoint.witness-quorum.mixed-mode.json",
    );
    let mixed_mode = run(&[
        "verify-remote-factory-release-registry-history-receipt-quorum-log-checkpoint-witness-receipt-quorum-log-checkpoint-witnesses",
        path(&checkpoint_witness_receipt_quorum_log),
        ...
        path(&final_checkpoint_witness_a_rotated),
        "--witness-public-keys",
        path(&final_checkpoint_witness_a_next_public),
        "--witness-trust-states",
        path(&final_checkpoint_witness_a_rotated_trust),
        "--minimum-witnesses",
        "2",
        ...
        "5800",
        "--output",
        path(&final_checkpoint_witness_mixed_mode),
    ]);
    assert!(!mixed_mode.status.success());
    assert!(!final_checkpoint_witness_mixed_mode.exists());

    let final_checkpoint_witness_trust_schema = root.join(
        "registry-witness-receipts.remote-checkpoint-receipts.quorum.dedicated-checkpoint.witness-trust.schema.json",
    );
    successful(&[
        ...
        "--output",
        path(&final_checkpoint_witness_trust_schema),
    ]);
    assert_eq!(
        serde_json::from_slice::<Value>(&fs::read(&final_checkpoint_witness_trust_schema).unwrap())
            .unwrap()["additionalProperties"],
        false
    );
    let final_checkpoint_witness_rotation_schema = root.join(
        "registry-witness-receipts.remote-checkpoint-receipts.quorum.dedicated-checkpoint.witness-rotation.schema.json",
    );
    successful(&[
        ...
        "--output",
        path(&final_checkpoint_witness_rotation_schema),
    ]);
    assert_eq!(
        serde_json::from_slice::<Value>(
            &fs::read(&final_checkpoint_witness_rotation_schema).unwrap()
        )
        .unwrap()["additionalProperties"],
        false
    );
    let normalized_final_checkpoint_witness_trust = root.join(
        "registry-witness-receipts.remote-checkpoint-receipts.quorum.dedicated-checkpoint.witness-a.rotated.trust.normalized.json",
    );
    successful(&[
        ...
        path(&final_checkpoint_witness_a_rotated_trust),
        "--output",
        path(&normalized_final_checkpoint_witness_trust),
    ]);
    assert_eq!(
        fs::read(&normalized_final_checkpoint_witness_trust).unwrap(),
        fs::read(&final_checkpoint_witness_a_rotated_trust).unwrap()
    );
    let normalized_final_checkpoint_witness_rotation = root.join(
        "registry-witness-receipts.remote-checkpoint-receipts.quorum.dedicated-checkpoint.witness-a.rotation.normalized.json",
    );
    successful(&[
        ...
        path(&final_checkpoint_witness_a_rotation),
        "--output",
        path(&normalized_final_checkpoint_witness_rotation),
    ]);
    assert_eq!(
        fs::read(&normalized_final_checkpoint_witness_rotation).unwrap(),
        fs::read(&final_checkpoint_witness_a_rotation).unwrap()
    );

    let final_checkpoint_witness_a_public_before =
        fs::read(&final_checkpoint_witness_a_public).unwrap();
    let alias_rejected = run(&[
        "init-remote-factory-release-registry-history-receipt-quorum-log-checkpoint-witness-receipt-quorum-log-checkpoint-witness-trust",
        "--witness-id",
        "must-not-overwrite-key",
        "--public-key",
        path(&final_checkpoint_witness_a_public),
        "--output",
        path(&final_checkpoint_witness_a_public),
    ...
    assert_eq!(
        fs::read(&final_checkpoint_witness_a_public).unwrap(),
        final_checkpoint_witness_a_public_before
    );
    let final_checkpoint_witness_a_rotated_trust_before =
        fs::read(&final_checkpoint_witness_a_rotated_trust).unwrap();
    let no_clobber = run(&[
        "apply-remote-factory-release-registry-history-receipt-quorum-log-checkpoint-witness-receipt-quorum-log-checkpoint-witness-key-rotation",
        path(&final_checkpoint_witness_a_initial_trust),
    ...
    assert_eq!(
        fs::read(&final_checkpoint_witness_a_rotated_trust).unwrap(),
        final_checkpoint_witness_a_rotated_trust_before
    );

    let remote_final_checkpoint_witness_b = root.join(
        "registry-witness-receipts.remote-checkpoint-receipts.quorum.dedicated-checkpoint.witness-b.remote.json",
    );
    let remote_final_checkpoint_witness_b_receipt = root.join(
        "registry-witness-receipts.remote-checkpoint-receipts.quorum.dedicated-checkpoint.witness-b.remote.receipt.json",
    );
    let (endpoint, server) = serve_json_once_at(
        fs::read(&final_checkpoint_witness_b).unwrap(),
        Some("final-checkpoint-bounded-token"),
    ...
    let remote = Command::new(binary())
        .args([
            ...
            path(&final_checkpoint_witness_b_public),
            "--bearer-token-env",
            "PCBEX_FACTORY_FINAL_CHECKPOINT_WITNESS_TOKEN",
            "--timeout-seconds",
            "10",
            "--evaluated-at-unix",
            "5800",
            "--output",
            path(&remote_final_checkpoint_witness_b),
            "--receipt-output",
        ...
        .env(
            "PCBEX_FACTORY_FINAL_CHECKPOINT_WITNESS_TOKEN",
            "final-checkpoint-bounded-token",
        )
        .output()
        .unwrap();
    assert!(
    ...
    assert_eq!(
        request["quorum_report"],
        checkpoint_witness_receipt_quorum_report_value
    );
    assert_eq!(
        request["approval_log"],
        checkpoint_witness_receipt_quorum_log_value
    );
    assert_eq!(
        request["checkpoint"],
        dedicated_checkpoint_witness_receipt_quorum_checkpoint_value
    );
    assert_eq!(
        fs::read(&remote_final_checkpoint_witness_b).unwrap(),
        fs::read(&final_checkpoint_witness_b).unwrap()
    );
    let remote_final_checkpoint_witness_b_receipt_source =
        fs::read(&remote_final_checkpoint_witness_b_receipt).unwrap();
    let remote_final_checkpoint_witness_b_receipt_value: Value =
        serde_json::from_slice(&remote_final_checkpoint_witness_b_receipt_source).unwrap();
    assert_eq!(
        remote_final_checkpoint_witness_b_receipt_value["adapter"],
        "remote-factory-release-registry-receipt-quorum-log-checkpoint-witness-receipt-quorum-log-checkpoint-witness-https-v1"
    );
    assert_eq!(
        remote_final_checkpoint_witness_b_receipt_value["checkpoint_witness_receipt_quorum_report_source_sha256"],
        hex::encode(Sha256::digest(
            fs::read(&checkpoint_witness_receipt_quorum_report).unwrap()
        ))
    );
    assert_eq!(
        remote_final_checkpoint_witness_b_receipt_value["admission_log_source_sha256"],
        hex::encode(Sha256::digest(
            fs::read(&checkpoint_witness_receipt_quorum_log).unwrap()
        ))
    );
    assert_eq!(
        remote_final_checkpoint_witness_b_receipt_value["checkpoint_source_sha256"],
        hex::encode(Sha256::digest(
            fs::read(&dedicated_checkpoint_witness_receipt_quorum_checkpoint).unwrap()
        ))
    );
    ...
    assert_eq!(
        remote_final_checkpoint_witness_b_receipt_value["witness_key_trust_state_sha256"],
        Value::Null
    );
    assert_eq!(
        remote_final_checkpoint_witness_b_receipt_value["witness_key_generation"],
        Value::Null
    );
    assert_eq!(
        remote_final_checkpoint_witness_b_receipt_value["verified"],
        true
    );
    assert!(
        !String::from_utf8_lossy(&remote_final_checkpoint_witness_b_receipt_source)
            .contains("final-checkpoint-bounded-token")
    );

    let remote_final_checkpoint_witness_receipt_schema = root.join(
        "registry-witness-receipts.remote-checkpoint-receipts.quorum.dedicated-checkpoint.remote-witness-receipt.schema.json",
    );
    successful(&[
        ...
        "--output",
        path(&remote_final_checkpoint_witness_receipt_schema),
    ]);
    assert_closed_and_bounded(
        &serde_json::from_slice::<Value>(
            &fs::read(&remote_final_checkpoint_witness_receipt_schema).unwrap(),
        )
        .unwrap(),
    );
    let normalized_remote_final_checkpoint_witness_b_receipt = root.join(
        "registry-witness-receipts.remote-checkpoint-receipts.quorum.dedicated-checkpoint.witness-b.remote.receipt.normalized.json",
    );
    successful(&[
        ...
        "5800",
        "--output",
        path(&normalized_remote_final_checkpoint_witness_b_receipt),
    ]);
    assert_eq!(
        fs::read(&normalized_remote_final_checkpoint_witness_b_receipt).unwrap(),
    ...
    let remote_final_checkpoint_witness_a_rotated_receipt = root.join(
        "registry-witness-receipts.remote-checkpoint-receipts.quorum.dedicated-checkpoint.witness-a.rotated.remote.receipt.json",
    );
    let (endpoint, server) = serve_json_once_at(
    ...
    successful(&[
        ...
        "5800",
        "--output",
        path(&remote_final_checkpoint_witness_a_rotated),
        "--receipt-output",
        path(&remote_final_checkpoint_witness_a_rotated_receipt),
        "--allow-http-loopback",
    ]);
    server.join().unwrap();
    assert_eq!(
        fs::read(&remote_final_checkpoint_witness_a_rotated).unwrap(),
        fs::read(&final_checkpoint_witness_a_rotated).unwrap()
    );
    let remote_final_checkpoint_witness_a_rotated_receipt_source =
        fs::read(&remote_final_checkpoint_witness_a_rotated_receipt).unwrap();
    let remote_final_checkpoint_witness_a_rotated_receipt_value: Value =
        serde_json::from_slice(&remote_final_checkpoint_witness_a_rotated_receipt_source).unwrap();
    assert_eq!(
        remote_final_checkpoint_witness_a_rotated_receipt_value["witness_key_generation"],
        1
    );
    assert_eq!(
        remote_final_checkpoint_witness_a_rotated_receipt_value["witness_key_trust_state_sha256"],
        hex::encode(Sha256::digest(
            fs::read(&final_checkpoint_witness_a_rotated_trust).unwrap()
        ))
    );
    let normalized_remote_final_checkpoint_witness_a_rotated_receipt = root.join(
        "registry-witness-receipts.remote-checkpoint-receipts.quorum.dedicated-checkpoint.witness-a.rotated.remote.receipt.normalized.json",
    );
    successful(&[
        "validate-remote-factory-release-registry-history-receipt-quorum-log-checkpoint-witness-receipt-quorum-log-checkpoint-witness-receipt",
        path(&remote_final_checkpoint_witness_a_rotated_receipt),
        ...
        "5800",
        "--output",
        path(&normalized_remote_final_checkpoint_witness_a_rotated_receipt),
    ]);
    assert_eq!(
        fs::read(&normalized_remote_final_checkpoint_witness_a_rotated_receipt).unwrap(),
    ...
    let invalid_remote_final_report = root.join(
        "registry-witness-receipts.remote-checkpoint-receipts.quorum.invalid-for-final-remote.json",
    );
    write_canonical_json(
        &invalid_remote_final_report,
        &invalid_remote_final_report_value,
    );
    let invalid_remote_final_witness = root.join(
        "registry-witness-receipts.remote-checkpoint-receipts.quorum.invalid-final-remote-witness.json",
    );
    let invalid_remote_final_receipt = root.join(
        "registry-witness-receipts.remote-checkpoint-receipts.quorum.invalid-final-remote-receipt.json",
    );
    let rejected = Command::new(binary())
        .args([
            ...
            path(&witness_a_next_public),
            "--endpoint",
            "http://127.0.0.1:9/v1/factory-receipt-quorum-checkpoint-witness",
            "--witness-public-key",
            path(&final_checkpoint_witness_b_public),
            "--bearer-token-env",
            "PCBEX_FINAL_WITNESS_TOKEN_MUST_NOT_BE_READ",
            "--evaluated-at-unix",
            "5800",
            "--output",
            path(&invalid_remote_final_witness),
            "--receipt-output",
            path(&invalid_remote_final_receipt),
            "--allow-http-loopback",
        ])
        .env_remove("PCBEX_FINAL_WITNESS_TOKEN_MUST_NOT_BE_READ")
        .output()
        .unwrap();
    assert!(!rejected.status.success());
    ...
    let rejected = run(&[
        ...
        "5800",
        "--output",
        path(&substituted_remote_final_receipt),
    ]);
    assert!(!rejected.status.success());
    assert!(!substituted_remote_final_receipt.exists());

    let final_checkpoint_witness_quorum_schema = root.join(
        "registry-witness-receipts.remote-checkpoint-receipts.quorum.dedicated-checkpoint.witness-quorum.schema.json",
    );
    successful(&[
        ...
        "--output",
        path(&final_checkpoint_witness_quorum_schema),
    ]);
    assert_eq!(
        serde_json::from_slice::<Value>(
            &fs::read(&final_checkpoint_witness_quorum_schema).unwrap()
        )
        .unwrap()["additionalProperties"],
        false
    );
    let normalized_final_checkpoint_witness_quorum = root.join(
        "registry-witness-receipts.remote-checkpoint-receipts.quorum.dedicated-checkpoint.witness-quorum.normalized.json",
    );
    successful(&[
        ...
        path(&final_checkpoint_witness_quorum),
        "--output",
        path(&normalized_final_checkpoint_witness_quorum),
    ]);
    assert_eq!(
        fs::read(&normalized_final_checkpoint_witness_quorum).unwrap(),
        fs::read(&final_checkpoint_witness_quorum).unwrap()
    );

    let final_checkpoint_witness_below_threshold = root.join(
        "registry-witness-receipts.remote-checkpoint-receipts.quorum.dedicated-checkpoint.witness-quorum.below-threshold.json",
    );
    let final_below_threshold = run(&[
        "verify-remote-factory-release-registry-history-receipt-quorum-log-checkpoint-witness-receipt-quorum-log-checkpoint-witnesses",
        path(&checkpoint_witness_receipt_quorum_log),
        "--quorum-report",
        path(&checkpoint_witness_receipt_quorum_report),
        ...
        "5800",
        "--output",
        path(&final_checkpoint_witness_below_threshold),
    ]);
    assert!(!final_below_threshold.status.success());
    let final_below_threshold_value: Value =
        serde_json::from_slice(&fs::read(&final_checkpoint_witness_below_threshold).unwrap())
            .unwrap();
    assert_eq!(final_below_threshold_value["quorum_met"], false);
    assert_eq!(
        final_below_threshold_value["status"],
        "insufficient_witnesses"
    );

    let final_witness_private_key_must_not_be_read =
        root.join("final-checkpoint-witness-forbidden-missing.key");
    let mismatched_final_witness = root.join(
        "registry-witness-receipts.remote-checkpoint-receipts.quorum.dedicated-checkpoint.mismatched-witness.json",
    );
    let mismatched_final_witness_result = run(&[
        "witness-remote-factory-release-registry-history-receipt-quorum-log-checkpoint-witness-receipt-quorum-log-checkpoint",
        path(&remote_checkpoint_witness_receipt_log_empty),
        "--quorum-report",
        path(&checkpoint_witness_receipt_quorum_report),
        ...
        path(&witness_a_next_public),
        "--private-key",
        path(&final_witness_private_key_must_not_be_read),
        "--witness-id",
        "checkpoint-receipt-quorum-witness-a",
        "--witnessed-at-unix",
        "5700",
        "--output",
        path(&mismatched_final_witness),
    ]);
    assert!(!mismatched_final_witness_result.status.success());
    let mismatched_final_witness_stderr =
        String::from_utf8_lossy(&mismatched_final_witness_result.stderr);
    assert!(
        mismatched_final_witness_stderr.contains(
            "does not match the remote factory release checkpoint-witness receipt quorum admission binding"
        ),
        "{mismatched_final_witness_stderr}"
    );
    assert!(!mismatched_final_witness.exists());

    let mut old_domain_final_witness_payload =
        b"pcbex-factory-release-registry-receipt-quorum-log-checkpoint-witness-v1\0".to_vec();
    old_domain_final_witness_payload.extend(
        serde_json::to_vec(&serde_json::json!({
            "schema_version": final_checkpoint_witness_a_value["schema_version"],
            "checkpoint_sha256": final_checkpoint_witness_a_value["checkpoint_sha256"],
            "registry_id": final_checkpoint_witness_a_value["registry_id"],
            "generation": final_checkpoint_witness_a_value["generation"],
            "receipt_quorum_checkpoint_sha256": final_checkpoint_witness_a_value["receipt_quorum_checkpoint_sha256"],
            "admission_log_id": final_checkpoint_witness_a_value["admission_log_id"],
            "admission_log_entry_count": final_checkpoint_witness_a_value["admission_log_entry_count"],
            "admission_log_head_sha256": final_checkpoint_witness_a_value["admission_log_head_sha256"],
            "admission_log_sha256": final_checkpoint_witness_a_value["admission_log_sha256"],
            "witness_id": final_checkpoint_witness_a_value["witness_id"],
            "witnessed_at_unix": final_checkpoint_witness_a_value["witnessed_at_unix"],
            "algorithm": final_checkpoint_witness_a_value["algorithm"]
        }))
        .unwrap(),
    );
    let old_domain_final_witness_signature = hex::encode(
        SigningKey::from_bytes(&[88; 32])
            .sign(&old_domain_final_witness_payload)
            .to_bytes(),
    );
    let old_domain_final_witness = root.join(
        "registry-witness-receipts.remote-checkpoint-receipts.quorum.dedicated-checkpoint.old-domain-witness.json",
    );
    fs::write(
        &old_domain_final_witness,
        fs::read_to_string(&final_checkpoint_witness_a)
            .unwrap()
            .replacen(
                final_checkpoint_witness_a_value["signature"]
                    .as_str()
                    .unwrap(),
                &old_domain_final_witness_signature,
                1,
            ),
    )
    .unwrap();
    let old_domain_final_witness_quorum = root.join(
        "registry-witness-receipts.remote-checkpoint-receipts.quorum.dedicated-checkpoint.old-domain-witness-quorum.json",
    );
    let old_domain_final_witness_result = run(&[
        "verify-remote-factory-release-registry-history-receipt-quorum-log-checkpoint-witness-receipt-quorum-log-checkpoint-witnesses",
        path(&checkpoint_witness_receipt_quorum_log),
        "--quorum-report",
        path(&checkpoint_witness_receipt_quorum_report),
        ...
        "5800",
        "--output",
        path(&old_domain_final_witness_quorum),
    ]);
    assert!(!old_domain_final_witness_result.status.success());
    let old_domain_final_witness_stderr =
        String::from_utf8_lossy(&old_domain_final_witness_result.stderr);
    assert!(
        old_domain_final_witness_stderr.contains(
            "invalid factory checkpoint-witness receipt quorum checkpoint witness signature"
        ),
        "{old_domain_final_witness_stderr}"
    );
    assert!(!old_domain_final_witness_quorum.exists());
    ...
    let below_threshold_report =
        root.join("registry-witness-receipts.remote-checkpoint-receipts.below-threshold.json");
    let below_threshold = run(&[
        "append-verified-remote-factory-release-registry-history-receipt-quorum-log-checkpoint-witness-receipt-quorum",
        path(&remote_checkpoint_witness_receipt_log_empty),
        "--receipt",
        ...
        "5600",
        "--output",
        path(&below_threshold_log),
        "--report-output",
        path(&below_threshold_report),
    ]);
    assert!(!below_threshold.status.success());
    assert!(!below_threshold_log.exists());
    assert!(!below_threshold_report.exists());

    let substituted_response =
        root.join("registry-witness-receipts.dedicated-checkpoint.substituted-response.json");
    fs::copy(
        &remote_dedicated_checkpoint_witness_b,
        &substituted_response,
    )
    .unwrap();
    let substituted_quorum_log =
        root.join("registry-witness-receipts.remote-checkpoint-receipts.log.substituted.json");
    let substituted_quorum_report =
        root.join("registry-witness-receipts.remote-checkpoint-receipts.substituted.json");
    let substituted = run(&[
        "append-verified-remote-factory-release-registry-history-receipt-quorum-log-checkpoint-witness-receipt-quorum",
        path(&remote_checkpoint_witness_receipt_log_empty),
        "--receipt",
        ...
        "5600",
        "--output",
        path(&substituted_quorum_log),
        "--report-output",
        path(&substituted_quorum_report),
    ]);
    assert!(!substituted.status.success());
    assert!(!substituted_quorum_log.exists());
    assert!(!substituted_quorum_report.exists());
...
fn publishes_closed_bounded_registry_schemas() {
    ...
    for (command, filename) in [
        ...
        (
            "remote-factory-release-registry-history-receipt-quorum-log-checkpoint-witness-receipt-quorum-log-checkpoint-witness-receipt-schema",
            "remote-history-receipt-quorum-log-checkpoint-witness-receipt-quorum-log-checkpoint-witness-receipt.schema.json",
        ),
        (
