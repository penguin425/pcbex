...
//!
//! The v1.514 boundary signs that exact canonical report and admission log
...
//!
//! The v1.516 boundary binds each v1.515 dedicated-checkpoint witness identity
//! to a generation-zero trust state and advances its key only through a
//! dual-signed, digest-chained, one-generation rotation. The unchanged v1.515
//! quorum can consume either direct key pins or current trust states.
//!
//! The v1.517 boundary acquires one unchanged v1.515 witness through bounded
//! HTTPS. It sends the exact v1.512 report, admission log, and v1.514
...
//!
//! The v1.521 boundary extends that verifier-bound admission to a bounded final
...
//!
//! The v1.523 boundary signs the same final report and log beneath a dedicated
//! final checkpoint-witness receipt-quorum domain. It commits to both prior
//! factory checkpoints so generic and earlier dedicated signatures cannot
//! substitute.
...
const FINAL_CHECKPOINT_WITNESS_RECEIPT_QUORUM_LOG_CHECKPOINT_DOMAIN: &str =
...
const CHECKPOINT_WITNESS_RECEIPT_QUORUM_LOG_CHECKPOINT_WITNESS_KEY_ROTATION_DOMAIN: &str = "pcbex-factory-release-registry-receipt-quorum-log-checkpoint-witness-receipt-quorum-log-checkpoint-witness-key-rotation-v1";
const CHECKPOINT_WITNESS_RECEIPT_QUORUM_LOG_CHECKPOINT_WITNESS_PROTOCOL: &str = "pcbex-remote-factory-release-registry-receipt-quorum-log-checkpoint-witness-receipt-quorum-log-checkpoint-witness-v1";
const CHECKPOINT_WITNESS_RECEIPT_QUORUM_LOG_CHECKPOINT_WITNESS_ADAPTER: &str = "remote-factory-release-registry-receipt-quorum-log-checkpoint-witness-receipt-quorum-log-checkpoint-witness-https-v1";
...
pub(crate) const MAX_REMOTE_FACTORY_RELEASE_REGISTRY_HISTORY_RECEIPT_QUORUM_LOG_CHECKPOINT_WITNESS_RECEIPT_QUORUM_REPORT_BYTES: u64 =
    128 * 1024;
pub(crate) const MAX_REMOTE_FACTORY_RELEASE_REGISTRY_HISTORY_RECEIPT_QUORUM_LOG_CHECKPOINT_WITNESS_RECEIPT_QUORUM_LOG_CHECKPOINT_BYTES: u64 =
    64 * 1024;
...
pub(crate) const MAX_REMOTE_FACTORY_RELEASE_REGISTRY_HISTORY_RECEIPT_QUORUM_LOG_CHECKPOINT_WITNESS_RECEIPT_QUORUM_LOG_CHECKPOINT_WITNESS_QUORUM_REPORT_BYTES: u64 =
    128 * 1024;
pub(crate) const MAX_REMOTE_FACTORY_RELEASE_REGISTRY_HISTORY_RECEIPT_QUORUM_LOG_CHECKPOINT_WITNESS_RECEIPT_QUORUM_LOG_CHECKPOINT_WITNESS_TRUST_STATE_BYTES: u64 =
    32 * 1024;
pub(crate) const MAX_SIGNED_REMOTE_FACTORY_RELEASE_REGISTRY_HISTORY_RECEIPT_QUORUM_LOG_CHECKPOINT_WITNESS_RECEIPT_QUORUM_LOG_CHECKPOINT_WITNESS_KEY_ROTATION_BYTES: u64 =
    32 * 1024;
pub(crate) const MAX_REMOTE_FACTORY_RELEASE_REGISTRY_HISTORY_RECEIPT_QUORUM_LOG_CHECKPOINT_WITNESS_RECEIPT_QUORUM_LOG_CHECKPOINT_WITNESS_RECEIPT_BYTES: u64 =
    64 * 1024;
pub(crate) const MAX_REMOTE_FACTORY_RELEASE_REGISTRY_HISTORY_RECEIPT_QUORUM_LOG_CHECKPOINT_WITNESS_RECEIPT_QUORUM_LOG_CHECKPOINT_WITNESS_RECEIPT_QUORUM_REPORT_BYTES: u64 =
    128 * 1024;
pub(crate) const MAX_SIGNED_REMOTE_FACTORY_RELEASE_FINAL_CHECKPOINT_WITNESS_RECEIPT_QUORUM_LOG_CHECKPOINT_BYTES: u64 =
    64 * 1024;
pub(crate) const MAX_REMOTE_FACTORY_RELEASE_FINAL_CHECKPOINT_WITNESS_RECEIPT_QUORUM_LOG_CHECKPOINT_VERIFICATION_BYTES: u64 =
    64 * 1024;
...
#[derive(Debug, Serialize)]
#[serde(deny_unknown_fields)]
struct RemoteFactoryReleaseRegistryHistoryReceiptQuorumLogCheckpointWitnessReceiptQuorumLogCheckpointWitnessRequest<'a>
{
    schema_version: u32,
    protocol: &'static str,
    quorum_report: &'a RemoteFactoryReleaseRegistryHistoryReceiptQuorumLogCheckpointWitnessReceiptQuorumReport,
    approval_log: &'a ApprovalTransparencyLog,
    checkpoint: &'a SignedRemoteFactoryReleaseRegistryHistoryReceiptQuorumLogCheckpointWitnessReceiptQuorumLogCheckpoint,
}
...
#[derive(Clone, Debug, Eq, PartialEq, Serialize, Deserialize)]
#[serde(deny_unknown_fields)]
pub(crate) struct SignedRemoteFactoryReleaseRegistryHistoryReceiptQuorumLogCheckpointWitnessReceiptQuorumLogCheckpoint
{
    pub(crate) schema_version: u32,
    pub(crate) checkpoint_witness_receipt_quorum_report_sha256: String,
    pub(crate) registry_id: String,
    pub(crate) generation: u64,
    pub(crate) registry_checkpoint_sha256: String,
...
#[derive(Clone, Debug, Eq, PartialEq, Serialize, Deserialize)]
#[serde(deny_unknown_fields)]
pub(crate) struct RemoteFactoryReleaseRegistryHistoryReceiptQuorumLogCheckpointWitnessReceiptQuorumLogCheckpointVerification
{
    pub(crate) schema_version: u32,
    pub(crate) checkpoint_witness_receipt_quorum_report_sha256: String,
    pub(crate) registry_id: String,
...
#[derive(Clone, Debug, Eq, PartialEq, Serialize, Deserialize)]
#[serde(deny_unknown_fields)]
pub(crate) struct RemoteFactoryReleaseRegistryHistoryReceiptQuorumLogCheckpointWitnessReceiptQuorumLogCheckpointWitnessTrustState
{
    pub(crate) schema_version: u32,
    pub(crate) witness_id: String,
    pub(crate) generation: u64,
...
#[derive(Clone, Debug, Eq, PartialEq, Serialize, Deserialize)]
#[serde(deny_unknown_fields)]
pub(crate) struct SignedRemoteFactoryReleaseRegistryHistoryReceiptQuorumLogCheckpointWitnessReceiptQuorumLogCheckpointWitnessKeyRotation
{
    pub(crate) schema_version: u32,
    pub(crate) witness_id: String,
    pub(crate) from_generation: u64,
...
#[derive(Clone, Debug, Eq, PartialEq, Serialize, Deserialize)]
#[serde(deny_unknown_fields)]
pub(crate) struct RemoteFactoryReleaseRegistryHistoryReceiptQuorumLogCheckpointWitnessReceiptQuorumLogCheckpointWitnessReceipt
{
    pub(crate) schema_version: u32,
    pub(crate) adapter: String,
    pub(crate) endpoint: String,
    pub(crate) checkpoint_witness_receipt_quorum_report_sha256: String,
    pub(crate) checkpoint_witness_receipt_quorum_report_source_sha256: String,
    pub(crate) registry_id: String,
    pub(crate) generation: u64,
    pub(crate) registry_checkpoint_sha256: String,
    pub(crate) receipt_quorum_checkpoint_sha256: String,
    ...
    pub(crate) admission_log_head_sha256: String,
    pub(crate) admission_log_sha256: String,
    pub(crate) admission_log_source_sha256: String,
    pub(crate) checkpoint_sha256: String,
    pub(crate) checkpoint_source_sha256: String,
    pub(crate) checkpoint_public_key: String,
    pub(crate) request_sha256: String,
...
#[derive(Clone, Debug, Eq, PartialEq, Serialize, Deserialize)]
#[serde(deny_unknown_fields)]
pub(crate) struct RemoteFactoryReleaseRegistryHistoryReceiptQuorumLogCheckpointWitnessReceiptQuorumLogCheckpointWitnessReceiptQuorumMember
{
    pub(crate) witness_id: String,
    pub(crate) witness_public_key: String,
    pub(crate) witness_key_trust_state_sha256: Option<String>,
...
#[derive(Clone, Debug, Eq, PartialEq, Serialize, Deserialize)]
#[serde(deny_unknown_fields)]
pub(crate) struct RemoteFactoryReleaseRegistryHistoryReceiptQuorumLogCheckpointWitnessReceiptQuorumLogCheckpointWitnessReceiptQuorumReport
{
    pub(crate) schema_version: u32,
    pub(crate) checkpoint_witness_receipt_quorum_report_sha256: String,
    pub(crate) checkpoint_witness_receipt_quorum_report_source_sha256: String,
    ...
    pub(crate) valid_witnesses: u32,
    pub(crate) members: Vec<
        RemoteFactoryReleaseRegistryHistoryReceiptQuorumLogCheckpointWitnessReceiptQuorumLogCheckpointWitnessReceiptQuorumMember,
    >,
    pub(crate) quorum_met: bool,
    pub(crate) final_admission_log_id: Option<String>,
    pub(crate) final_admission_log_entry_count: Option<u64>,
    pub(crate) final_admission_log_head_sha256: Option<String>,
    pub(crate) final_admission_log_sha256: Option<String>,
}

#[derive(Clone, Debug, Eq, PartialEq, Serialize, Deserialize)]
#[serde(deny_unknown_fields)]
pub(crate) struct SignedRemoteFactoryReleaseFinalCheckpointWitnessReceiptQuorumLogCheckpoint {
    pub(crate) schema_version: u32,
...
#[derive(Clone, Debug, Eq, PartialEq, Serialize, Deserialize)]
#[serde(deny_unknown_fields)]
pub(crate) struct RemoteFactoryReleaseFinalCheckpointWitnessReceiptQuorumLogCheckpointVerification {
    pub(crate) schema_version: u32,
    pub(crate) final_checkpoint_witness_receipt_quorum_report_sha256: String,
    pub(crate) registry_id: String,
    pub(crate) generation: u64,
...
struct RemoteCheckpointWitnessReceiptQuorumLogCheckpointWitnessVerificationContext {
    report:
...
pub(crate) fn render_signed_remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint(
    checkpoint: &SignedRemoteFactoryReleaseRegistryHistoryReceiptQuorumLogCheckpointWitnessReceiptQuorumLogCheckpoint,
) -> Result<Vec<u8>, String> {
    ...
    render_bounded(
        checkpoint,
        MAX_REMOTE_FACTORY_RELEASE_REGISTRY_HISTORY_RECEIPT_QUORUM_LOG_CHECKPOINT_WITNESS_RECEIPT_QUORUM_LOG_CHECKPOINT_BYTES,
        "signed factory checkpoint-witness receipt quorum log checkpoint",
    )
}

pub(crate) fn parse_signed_remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint(
    source: &[u8],
) -> Result<
    SignedRemoteFactoryReleaseRegistryHistoryReceiptQuorumLogCheckpointWitnessReceiptQuorumLogCheckpoint,
    String,
>{
    let checkpoint = parse_canonical(
        source,
...
pub(crate) fn render_remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint_verification(
    verification: &RemoteFactoryReleaseRegistryHistoryReceiptQuorumLogCheckpointWitnessReceiptQuorumLogCheckpointVerification,
) -> Result<Vec<u8>, String> {
    validate_remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint_verification(
        verification,
    )?;
    render_bounded(
        verification,
        MAX_REMOTE_FACTORY_RELEASE_REGISTRY_HISTORY_RECEIPT_QUORUM_LOG_CHECKPOINT_WITNESS_RECEIPT_QUORUM_LOG_CHECKPOINT_VERIFICATION_BYTES,
        "factory checkpoint-witness receipt quorum log checkpoint verification",
    )
}

#[cfg(test)]
fn parse_remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint_verification(
    source: &[u8],
) -> Result<
    RemoteFactoryReleaseRegistryHistoryReceiptQuorumLogCheckpointWitnessReceiptQuorumLogCheckpointVerification,
    String,
>{
    let verification = parse_canonical(
        source,
...
pub(crate) fn render_remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint_witness_trust_state(
    state: &RemoteFactoryReleaseRegistryHistoryReceiptQuorumLogCheckpointWitnessReceiptQuorumLogCheckpointWitnessTrustState,
) -> Result<Vec<u8>, String> {
    validate_remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint_witness_trust_state(
        state,
    )?;
    render_bounded(
        state,
        MAX_REMOTE_FACTORY_RELEASE_REGISTRY_HISTORY_RECEIPT_QUORUM_LOG_CHECKPOINT_WITNESS_RECEIPT_QUORUM_LOG_CHECKPOINT_WITNESS_TRUST_STATE_BYTES,
        "factory checkpoint-witness receipt quorum checkpoint witness trust state",
    )
}

pub(crate) fn parse_remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint_witness_trust_state(
    source: &[u8],
) -> Result<
...
pub(crate) fn render_signed_remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint_witness_key_rotation(
    rotation: &SignedRemoteFactoryReleaseRegistryHistoryReceiptQuorumLogCheckpointWitnessReceiptQuorumLogCheckpointWitnessKeyRotation,
) -> Result<Vec<u8>, String> {
    validate_signed_remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint_witness_key_rotation(
        rotation,
    )?;
    render_bounded(
        rotation,
        MAX_SIGNED_REMOTE_FACTORY_RELEASE_REGISTRY_HISTORY_RECEIPT_QUORUM_LOG_CHECKPOINT_WITNESS_RECEIPT_QUORUM_LOG_CHECKPOINT_WITNESS_KEY_ROTATION_BYTES,
        "signed factory checkpoint-witness receipt quorum checkpoint witness key rotation",
    )
}

pub(crate) fn parse_signed_remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint_witness_key_rotation(
    source: &[u8],
) -> Result<
    SignedRemoteFactoryReleaseRegistryHistoryReceiptQuorumLogCheckpointWitnessReceiptQuorumLogCheckpointWitnessKeyRotation,
    String,
>{
    let rotation = parse_canonical(
        source,
...
#[allow(clippy::too_many_arguments)]
pub(crate) fn request_remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint_witness(
    quorum_report_source: &[u8],
    approval_log_source: &[u8],
    checkpoint_source: &[u8],
    trusted_checkpoint_public_key: &[u8; 32],
    ...
    String,
>{
    request_remote_checkpoint_witness_receipt_quorum_log_checkpoint_witness(
        quorum_report_source,
        approval_log_source,
        checkpoint_source,
        trusted_checkpoint_public_key,
...
#[allow(clippy::too_many_arguments)]
pub(crate) fn request_remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint_witness_with_trust_state(
    quorum_report_source: &[u8],
    approval_log_source: &[u8],
    checkpoint_source: &[u8],
    trusted_checkpoint_public_key: &[u8; 32],
    ...
    String,
>{
    let trust_state = parse_remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint_witness_trust_state(
        witness_key_trust_state_source,
    )?;
    let trusted_witness_public_key = remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint_witness_trusted_public_key(
        &trust_state,
    )?;
    request_remote_checkpoint_witness_receipt_quorum_log_checkpoint_witness(
        quorum_report_source,
...
#[allow(clippy::too_many_arguments)]
pub(crate) fn verify_remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint_witness_receipt(
    receipt: &RemoteFactoryReleaseRegistryHistoryReceiptQuorumLogCheckpointWitnessReceiptQuorumLogCheckpointWitnessReceipt,
    quorum_report_source: &[u8],
    approval_log_source: &[u8],
    checkpoint_source: &[u8],
    trusted_checkpoint_public_key: &[u8; 32],
    ...
    String,
>{
    verify_remote_checkpoint_witness_receipt_quorum_log_checkpoint_witness_receipt(
        receipt,
        quorum_report_source,
        approval_log_source,
        checkpoint_source,
...
#[allow(clippy::too_many_arguments)]
pub(crate) fn verify_remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint_witness_receipt_with_trust_state(
    receipt: &RemoteFactoryReleaseRegistryHistoryReceiptQuorumLogCheckpointWitnessReceiptQuorumLogCheckpointWitnessReceipt,
    quorum_report_source: &[u8],
    approval_log_source: &[u8],
    checkpoint_source: &[u8],
...
#[allow(clippy::too_many_arguments)]
fn verify_remote_checkpoint_witness_receipt_quorum_log_checkpoint_witness_receipt(
    receipt: &RemoteFactoryReleaseRegistryHistoryReceiptQuorumLogCheckpointWitnessReceiptQuorumLogCheckpointWitnessReceipt,
    quorum_report_source: &[u8],
    approval_log_source: &[u8],
    checkpoint_source: &[u8],
...
>{
    ...
    let witness =
        verify_remote_checkpoint_witness_receipt_quorum_log_checkpoint_witness_receipt_binding(
            receipt,
            &context,
            response_bytes,
            trusted_checkpoint_public_key,
    ...
    let single = verify_remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint_witnesses_after_checkpoint_verification(
        &context.report,
        &context.checkpoint,
        trusted_checkpoint_public_key,
        std::slice::from_ref(&witness),
    ...
    if single.valid_witnesses != 1 || single.quorum_met {
        return Err(
            "remote factory checkpoint-witness receipt quorum checkpoint witness admission produced an invalid single-witness result"
                .into(),
        );
    }
    Ok(witness)
...
fn prepare_remote_checkpoint_witness_receipt_quorum_log_checkpoint_witness_verification_context(
    quorum_report_source: &[u8],
    approval_log_source: &[u8],
    checkpoint_source: &[u8],
    trusted_checkpoint_public_key: &[u8; 32],
) -> Result<RemoteCheckpointWitnessReceiptQuorumLogCheckpointWitnessVerificationContext, String> {
    validate_nonweak_public_key(
        trusted_checkpoint_public_key,
        "trusted factory checkpoint-witness receipt quorum checkpoint key",
    )?;
    let report = parse_remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_report(
        quorum_report_source,
    )?;
    let approval_log = parse_remote_receipt_quorum_approval_log(approval_log_source)?;
    let checkpoint = parse_signed_remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint(
        checkpoint_source,
    )?;
    ...
    let request_bytes = serde_json::to_vec(
        &RemoteFactoryReleaseRegistryHistoryReceiptQuorumLogCheckpointWitnessReceiptQuorumLogCheckpointWitnessRequest {
            schema_version: 1,
            protocol: CHECKPOINT_WITNESS_RECEIPT_QUORUM_LOG_CHECKPOINT_WITNESS_PROTOCOL,
            quorum_report: &report,
            approval_log: &approval_log,
            checkpoint: &checkpoint,
        },
    ...
    .map_err(|error| {
        format!(
            "serializing remote factory checkpoint-witness receipt quorum checkpoint witness request: {error}"
        )
    })?;
    if request_bytes.is_empty()
        || request_bytes.len() as u64
            > MAX_CHECKPOINT_WITNESS_RECEIPT_QUORUM_LOG_CHECKPOINT_WITNESS_REQUEST_BYTES
    {
        return Err(format!(
            "remote factory checkpoint-witness receipt quorum checkpoint witness request exceeds {MAX_CHECKPOINT_WITNESS_RECEIPT_QUORUM_LOG_CHECKPOINT_WITNESS_REQUEST_BYTES} bytes"
        ));
    }
    Ok(
        RemoteCheckpointWitnessReceiptQuorumLogCheckpointWitnessVerificationContext {
            quorum_report_source_sha256: sha256(quorum_report_source),
            approval_log_source_sha256: sha256(approval_log_source),
            checkpoint_source_sha256: sha256(checkpoint_source),
...
#[allow(clippy::too_many_arguments)]
fn verify_remote_checkpoint_witness_receipt_quorum_log_checkpoint_witness_receipt_binding(
    receipt: &RemoteFactoryReleaseRegistryHistoryReceiptQuorumLogCheckpointWitnessReceiptQuorumLogCheckpointWitnessReceipt,
    context: &RemoteCheckpointWitnessReceiptQuorumLogCheckpointWitnessVerificationContext,
    response_bytes: &[u8],
    trusted_checkpoint_public_key: &[u8; 32],
    trusted_witness_public_key: &[u8; 32],
    witness_key_trust_state: Option<(
    ...
    String,
>{
    validate_remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint_witness_receipt(
        receipt,
    )?;
    if evaluated_at_unix > MAX_TIMESTAMP {
        return Err(
            "remote factory checkpoint-witness receipt quorum checkpoint witness admission time is outside its bound"
                .into(),
        );
    }
    if evaluated_at_unix < receipt.evaluated_at_unix {
        return Err(
            "remote factory checkpoint-witness receipt quorum checkpoint witness receipt is future-dated at admission"
                .into(),
        );
    }
    validate_nonweak_public_key(
    ...
    if receipt.checkpoint_witness_receipt_quorum_report_sha256
        != context
            .checkpoint
            .checkpoint_witness_receipt_quorum_report_sha256
        || receipt.checkpoint_witness_receipt_quorum_report_source_sha256
            != context.quorum_report_source_sha256
        || receipt.registry_id != context.checkpoint.registry_id
        || receipt.generation != context.checkpoint.generation
        || receipt.registry_checkpoint_sha256 != context.checkpoint.registry_checkpoint_sha256
        || receipt.receipt_quorum_checkpoint_sha256
            != context.checkpoint.receipt_quorum_checkpoint_sha256
        || receipt.admission_log_id != context.checkpoint.admission_log_id
        || receipt.admission_log_entry_count != context.checkpoint.admission_log_entry_count
        || receipt.admission_log_head_sha256 != context.checkpoint.admission_log_head_sha256
        || receipt.admission_log_sha256 != context.checkpoint.admission_log_sha256
        || receipt.admission_log_source_sha256 != context.approval_log_source_sha256
        || receipt.checkpoint_sha256 != context.checkpoint_sha256
        || receipt.checkpoint_source_sha256 != context.checkpoint_source_sha256
        || receipt.checkpoint_public_key != context.checkpoint_public_key
        || receipt.request_sha256 != context.request_sha256
    {
        return Err(
            "remote factory checkpoint-witness receipt quorum checkpoint witness receipt is bound to different retained evidence"
                .into(),
        );
    }
    if response_bytes.is_empty()
    ...
    {
        return Err(
            "remote factory checkpoint-witness receipt quorum checkpoint witness receipt response binding is invalid"
                .into(),
        );
    }
    let witness = parse_signed_remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint_witness(
        response_bytes,
    )?;
    if receipt.witness_sha256
        != signed_remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint_witness_sha256(
            &witness,
        )?
        || receipt.witness_id != witness.witness_id
        || receipt.witness_public_key != witness.public_key
    ...
    {
        return Err(
            "remote factory checkpoint-witness receipt quorum checkpoint witness receipt describes different witness evidence"
                .into(),
        );
    }
    let expected_trust_binding = witness_key_trust_state
    ...
    {
        return Err(
            "remote factory checkpoint-witness receipt quorum checkpoint witness receipt trust binding is invalid"
                .into(),
        );
    }
    if let Some((trust_state, _)) = &witness_key_trust_state
    ...
    {
        return Err(
            "remote factory checkpoint-witness receipt quorum checkpoint witness identity does not match its trust state"
                .into(),
        );
    }
    Ok(witness)
...
#[allow(clippy::too_many_arguments)]
pub(crate) fn verify_remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint_witness_receipt_quorum(
    receipts: &[RemoteFactoryReleaseRegistryHistoryReceiptQuorumLogCheckpointWitnessReceiptQuorumLogCheckpointWitnessReceipt],
    quorum_report_source: &[u8],
    approval_log_source: &[u8],
    checkpoint_source: &[u8],
    trusted_checkpoint_public_key: &[u8; 32],
    ...
    (
        Vec<RemoteFactoryReleaseRegistryHistoryReceiptQuorumLogCheckpointWitnessReceiptQuorumLogCheckpointWitnessReceipt>,
...
>{
    ...
    let mut trusted = BTreeMap::new();
    for (witness_id, public_key) in trusted_witnesses {
        validate_slug(witness_id, "factory final checkpoint witness id")?;
        validate_nonweak_public_key(public_key, "trusted factory final checkpoint witness key")?;
        if trusted.insert(witness_id.as_str(), public_key).is_some() {
            return Err(
    ...
    verify_remote_final_checkpoint_witness_receipt_quorum(
        receipts,
        response_documents,
        &context,
        trusted_checkpoint_public_key,
        ...
        |receipt, response| {
            ...
            let witness = verify_remote_checkpoint_witness_receipt_quorum_log_checkpoint_witness_receipt_binding(
                receipt,
                &context,
                response,
                trusted_checkpoint_public_key,
...
#[allow(clippy::too_many_arguments)]
pub(crate) fn verify_remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint_witness_receipt_quorum_with_trust_states(
    receipts: &[RemoteFactoryReleaseRegistryHistoryReceiptQuorumLogCheckpointWitnessReceiptQuorumLogCheckpointWitnessReceipt],
    quorum_report_source: &[u8],
    approval_log_source: &[u8],
    checkpoint_source: &[u8],
...
>{
    ...
    let mut trust_states = BTreeMap::new();
    for source in witness_key_trust_state_sources {
        let state = parse_remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint_witness_trust_state(
            source,
        )?;
        let public_key = remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint_witness_trusted_public_key(
            &state,
        )?;
        let witness_id = state.witness_id.clone();
        if trust_states
    ...
    verify_remote_final_checkpoint_witness_receipt_quorum(
        ...
        |receipt, response| {
            let (state, digest, public_key) = trust_states
                .get(receipt.witness_id.as_str())
                .ok_or_else(|| {
                    "remote factory final checkpoint-witness receipt quorum witness trust state is absent"
                        .to_string()
                })?;
            let witness = verify_remote_checkpoint_witness_receipt_quorum_log_checkpoint_witness_receipt_binding(
                receipt,
...
#[allow(clippy::too_many_arguments)]
fn verify_remote_final_checkpoint_witness_receipt_quorum(
    receipts: &[RemoteFactoryReleaseRegistryHistoryReceiptQuorumLogCheckpointWitnessReceiptQuorumLogCheckpointWitnessReceipt],
    response_documents: &[Vec<u8>],
    context: &RemoteCheckpointWitnessReceiptQuorumLogCheckpointWitnessVerificationContext,
    trusted_checkpoint_public_key: &[u8; 32],
...
>{
    ...
    {
        return Err(
            "remote factory final checkpoint-witness receipt quorum input count is invalid"
                .into(),
        );
    }
    let mut verified = Vec::with_capacity(receipts.len());
    ...
    let trusted_keys = verified
        ...
        .map(|(_, _, trusted_key, _)| *trusted_key)
        .collect::<Vec<_>>();
    let witness_report = verify_remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint_witnesses_after_checkpoint_verification(
        &context.report,
        &context.checkpoint,
        trusted_checkpoint_public_key,
        &witnesses,
    ...
    let report = RemoteFactoryReleaseRegistryHistoryReceiptQuorumLogCheckpointWitnessReceiptQuorumLogCheckpointWitnessReceiptQuorumReport {
        schema_version: 1,
        checkpoint_witness_receipt_quorum_report_sha256: context
            .checkpoint
            .checkpoint_witness_receipt_quorum_report_sha256
            .clone(),
        checkpoint_witness_receipt_quorum_report_source_sha256: context
            .quorum_report_source_sha256
            .clone(),
        registry_id: context.checkpoint.registry_id.clone(),
        generation: context.checkpoint.generation,
        registry_checkpoint_sha256: context.checkpoint.registry_checkpoint_sha256.clone(),
        receipt_quorum_checkpoint_sha256: context
            ...
            .clone(),
        admission_log_id: context.checkpoint.admission_log_id.clone(),
        admission_log_entry_count: context.checkpoint.admission_log_entry_count,
        admission_log_head_sha256: context.checkpoint.admission_log_head_sha256.clone(),
        admission_log_sha256: context.checkpoint.admission_log_sha256.clone(),
        admission_log_source_sha256: context.approval_log_source_sha256.clone(),
        checkpoint_sha256: context.checkpoint_sha256.clone(),
        checkpoint_source_sha256: context.checkpoint_source_sha256.clone(),
        checkpoint_public_key: context.checkpoint_public_key.clone(),
        evaluated_at_unix,
        ...
        members,
        quorum_met: witness_report.quorum_met,
        final_admission_log_id: None,
        final_admission_log_entry_count: None,
        final_admission_log_head_sha256: None,
        final_admission_log_sha256: None,
    };
    validate_remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint_witness_receipt_quorum_report(
        &report,
    )?;
    Ok((
        verified
...
#[allow(clippy::too_many_arguments)]
fn request_remote_checkpoint_witness_receipt_quorum_log_checkpoint_witness(
    quorum_report_source: &[u8],
    approval_log_source: &[u8],
    checkpoint_source: &[u8],
    trusted_checkpoint_public_key: &[u8; 32],
...
>{
    if !(1..=600).contains(&timeout_seconds) {
        return Err(
            "remote factory checkpoint-witness receipt quorum checkpoint witness timeout must be between 1 and 600 seconds"
                .into(),
        );
    }
    if evaluated_at_unix > MAX_TIMESTAMP {
    ...
    let request = RemoteFactoryReleaseRegistryHistoryReceiptQuorumLogCheckpointWitnessReceiptQuorumLogCheckpointWitnessRequest {
        schema_version: 1,
        protocol: CHECKPOINT_WITNESS_RECEIPT_QUORUM_LOG_CHECKPOINT_WITNESS_PROTOCOL,
    ...
    if let Some(variable) = bearer_token_env {
        ...
        let token = env::var(variable).map_err(|_| {
            format!(
                "remote factory checkpoint-witness receipt quorum checkpoint witness bearer-token environment {variable} is unset"
            )
        })?;
        if token.trim().is_empty()
            || token.len() > 8 * 1024
        ...
        {
            return Err(format!(
                "remote factory checkpoint-witness receipt quorum checkpoint witness bearer-token environment {variable} is invalid"
            ));
        }
        call = call.header("Authorization", &format!("Bearer {token}"));
    }
    let mut response = call.send(request_bytes).map_err(|error| {
        format!(
            "remote factory checkpoint-witness receipt quorum checkpoint witness HTTPS request failed: {error}"
        )
    })?;
    if response.status().as_u16() != 200 {
        return Err(format!(
            "remote factory checkpoint-witness receipt quorum checkpoint witness returned unexpected HTTP status {}",
            response.status()
        ));
    }
    if response.body().mime_type() != Some("application/json") {
        return Err(
            "remote factory checkpoint-witness receipt quorum checkpoint witness response Content-Type must be application/json"
                .into(),
        );
    }
    let response_bytes = response
        ...
        .map_err(|error| {
            format!(
                "reading bounded remote factory checkpoint-witness receipt quorum checkpoint witness response: {error}"
            )
        })?;
    if response_bytes.len() as u64 > MAX_RESPONSE_BYTES {
        return Err(format!(
            "remote factory checkpoint-witness receipt quorum checkpoint witness response exceeds {MAX_RESPONSE_BYTES} bytes"
        ));
    }
    let witness = parse_signed_remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint_witness(
        &response_bytes,
    ...
    let single = verify_remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint_witnesses(
        &context.report,
    ...
    if single.valid_witnesses != 1 || single.quorum_met {
        return Err(
            "remote factory checkpoint-witness receipt quorum checkpoint witness verification produced an invalid single-witness result"
                .into(),
        );
    }
    let (witness_key_trust_state_sha256, witness_key_generation) = witness_key_trust_state
        .map(|(state, digest)| (Some(digest), Some(state.generation)))
        .unwrap_or((None, None));
    let receipt = RemoteFactoryReleaseRegistryHistoryReceiptQuorumLogCheckpointWitnessReceiptQuorumLogCheckpointWitnessReceipt {
        schema_version: 1,
        adapter: CHECKPOINT_WITNESS_RECEIPT_QUORUM_LOG_CHECKPOINT_WITNESS_ADAPTER.into(),
        endpoint: endpoint.into(),
        checkpoint_witness_receipt_quorum_report_sha256: context
            .checkpoint
            .checkpoint_witness_receipt_quorum_report_sha256
        ...
        admission_log_head_sha256: context.checkpoint.admission_log_head_sha256.clone(),
        admission_log_sha256: context.checkpoint.admission_log_sha256.clone(),
        admission_log_source_sha256: context.approval_log_source_sha256,
        ...
        response_sha256: sha256(&response_bytes),
        response_bytes: response_bytes.len() as u64,
        witness_sha256: signed_remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint_witness_sha256(
            &witness,
        )?,
        evaluated_at_unix,
        witness_id: witness.witness_id.clone(),
...
pub(crate) fn render_remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint_witness_receipt(
    receipt: &RemoteFactoryReleaseRegistryHistoryReceiptQuorumLogCheckpointWitnessReceiptQuorumLogCheckpointWitnessReceipt,
) -> Result<Vec<u8>, String> {
    validate_remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint_witness_receipt(
        receipt,
    ...
    render_bounded(
        receipt,
        MAX_REMOTE_FACTORY_RELEASE_REGISTRY_HISTORY_RECEIPT_QUORUM_LOG_CHECKPOINT_WITNESS_RECEIPT_QUORUM_LOG_CHECKPOINT_WITNESS_RECEIPT_BYTES,
        "remote factory checkpoint-witness receipt quorum checkpoint witness receipt",
    )
}

pub(crate) fn parse_remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint_witness_receipt(
    source: &[u8],
) -> Result<
    RemoteFactoryReleaseRegistryHistoryReceiptQuorumLogCheckpointWitnessReceiptQuorumLogCheckpointWitnessReceipt,
    String,
...
pub(crate) fn render_remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint_witness_receipt_quorum_report(
...
pub(crate) fn parse_remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint_witness_receipt_quorum_report(
    source: &[u8],
) -> Result<
    RemoteFactoryReleaseRegistryHistoryReceiptQuorumLogCheckpointWitnessReceiptQuorumLogCheckpointWitnessReceiptQuorumReport,
    String,
...
pub(crate) fn render_signed_remote_factory_release_final_checkpoint_witness_receipt_quorum_log_checkpoint(
    ...
    render_bounded(
        ...
        "signed factory final checkpoint-witness receipt quorum log checkpoint",
    )
}

pub(crate) fn parse_signed_remote_factory_release_final_checkpoint_witness_receipt_quorum_log_checkpoint(
    source: &[u8],
) -> Result<SignedRemoteFactoryReleaseFinalCheckpointWitnessReceiptQuorumLogCheckpoint, String> {
    let checkpoint = parse_canonical(
        source,
        MAX_SIGNED_REMOTE_FACTORY_RELEASE_FINAL_CHECKPOINT_WITNESS_RECEIPT_QUORUM_LOG_CHECKPOINT_BYTES,
        "signed factory final checkpoint-witness receipt quorum log checkpoint",
...
pub(crate) fn render_remote_factory_release_final_checkpoint_witness_receipt_quorum_log_checkpoint_verification(
    verification: &RemoteFactoryReleaseFinalCheckpointWitnessReceiptQuorumLogCheckpointVerification,
) -> Result<Vec<u8>, String> {
    validate_remote_factory_release_final_checkpoint_witness_receipt_quorum_log_checkpoint_verification(
        verification,
    )?;
    render_bounded(
        verification,
        MAX_REMOTE_FACTORY_RELEASE_FINAL_CHECKPOINT_WITNESS_RECEIPT_QUORUM_LOG_CHECKPOINT_VERIFICATION_BYTES,
        "factory final checkpoint-witness receipt quorum log checkpoint verification",
    )
}

#[cfg(test)]
fn parse_remote_factory_release_final_checkpoint_witness_receipt_quorum_log_checkpoint_verification(
    source: &[u8],
) -> Result<RemoteFactoryReleaseFinalCheckpointWitnessReceiptQuorumLogCheckpointVerification, String>
{
    let verification = parse_canonical(
        source,
        MAX_REMOTE_FACTORY_RELEASE_FINAL_CHECKPOINT_WITNESS_RECEIPT_QUORUM_LOG_CHECKPOINT_VERIFICATION_BYTES,
...
fn signed_remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint_witness_sha256(
    witness: &SignedRemoteFactoryReleaseRegistryHistoryReceiptQuorumLogCheckpointWitnessReceiptQuorumLogCheckpointWitness,
    ...
    serde_json::to_vec(witness)
        ...
        .map_err(|error| {
            format!(
                "serializing factory checkpoint-witness receipt quorum checkpoint witness: {error}"
            )
        })
}

fn validate_remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint_witness_receipt(
    receipt: &RemoteFactoryReleaseRegistryHistoryReceiptQuorumLogCheckpointWitnessReceiptQuorumLogCheckpointWitnessReceipt,
) -> Result<(), String> {
    if receipt.schema_version != 1
        || receipt.adapter
            != CHECKPOINT_WITNESS_RECEIPT_QUORUM_LOG_CHECKPOINT_WITNESS_ADAPTER
        || !receipt.verified
        || receipt.generation
            > MAX_FACTORY_RELEASE_STATE_TRANSPARENCY_EXTERNAL_GOSSIP_REGISTRY_GENERATION
        || receipt.admission_log_entry_count < 2
    ...
    {
        return Err(
            "remote factory checkpoint-witness receipt quorum checkpoint witness receipt invariants are invalid"
                .into(),
        );
    }
    ...
    validate_slug(
        &receipt.admission_log_id,
        "factory checkpoint-witness receipt quorum admission log id",
    )?;
    validate_slug(
        &receipt.witness_id,
    ...
    for (digest, label) in [
        (
            &receipt.checkpoint_witness_receipt_quorum_report_sha256,
            "checkpoint-witness receipt quorum report SHA-256",
        ),
        (
            &receipt.checkpoint_witness_receipt_quorum_report_source_sha256,
        ...
        (
            &receipt.admission_log_head_sha256,
            "admission log head SHA-256",
        ),
        (&receipt.admission_log_sha256, "admission log SHA-256"),
        (
            &receipt.admission_log_source_sha256,
        ...
        (
            ...
            "factory checkpoint-witness receipt quorum checkpoint source SHA-256",
        ),
        ...
        (
            ...
            "factory checkpoint-witness receipt quorum checkpoint witness SHA-256",
        ),
    ] {
    ...
    let checkpoint_public_key = decode_hex::<32>(
        ...
        "factory checkpoint-witness receipt quorum checkpoint public key",
    )?;
    validate_nonweak_public_key(
    ...
    match (
        ...
        (Some(digest), Some(generation)) => {
            ...
            {
                return Err(
                    "remote checkpoint-witness receipt quorum checkpoint witness receipt key generation is outside its bound"
                        .into(),
                );
            }
        }
        _ => {
            return Err(
                "remote checkpoint-witness receipt quorum checkpoint witness receipt trust-state binding is incomplete"
                    .into(),
            );
        }
    }
...
pub(crate) fn validate_remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint_witness_receipt_quorum_report(
    report: &RemoteFactoryReleaseRegistryHistoryReceiptQuorumLogCheckpointWitnessReceiptQuorumLogCheckpointWitnessReceiptQuorumReport,
) -> Result<(), String> {
    ...
    for (digest, label) in [
        (
            &report.checkpoint_witness_receipt_quorum_report_sha256,
            "checkpoint-witness receipt quorum report SHA-256",
        ),
        (
            &report.checkpoint_witness_receipt_quorum_report_source_sha256,
            "checkpoint-witness receipt quorum report source SHA-256",
        ),
        (
        ...
        (
            ...
            "checkpoint-witness receipt admission log head SHA-256",
        ),
        (
            &report.admission_log_sha256,
            "checkpoint-witness receipt admission log SHA-256",
        ),
        (
            &report.admission_log_source_sha256,
            "checkpoint-witness receipt admission log source SHA-256",
        ),
        (
            &report.checkpoint_sha256,
            "final checkpoint-witness receipt quorum checkpoint SHA-256",
        ),
        (
            &report.checkpoint_source_sha256,
            "final checkpoint-witness receipt quorum checkpoint source SHA-256",
        ),
    ] {
        validate_digest(digest, label)?;
    }
    let checkpoint_public_key = decode_hex::<32>(
        ...
        "final checkpoint-witness receipt quorum checkpoint public key",
    )?;
    validate_nonweak_public_key(
        &checkpoint_public_key,
        "final checkpoint-witness receipt quorum checkpoint public key",
    ...
    match (
        ...
        report.final_admission_log_entry_count,
        ...
        (Some(log_id), Some(entry_count), Some(head), Some(log_sha256)) => {
            ...
            validate_slug(log_id, "final receipt admission log id")?;
            ...
            validate_digest(head, "final receipt admission log head SHA-256")?;
            validate_digest(log_sha256, "final receipt admission log SHA-256")?;
        }
        _ => {
            return Err(
    ...
    for member in &report.members {
        validate_slug(&member.witness_id, "factory final checkpoint witness id")?;
        let witness_public_key = decode_hex::<32>(
            &member.witness_public_key,
            "factory final checkpoint witness public key",
        )?;
        validate_nonweak_public_key(
            &witness_public_key,
            "factory final checkpoint witness public key",
        ...
        if witness_public_key == checkpoint_public_key {
            return Err(
                "factory final checkpoint witness key must be independent from the checkpoint signing key"
                    .into(),
            );
        }
        ...
        match (
            ...
            (Some(digest), Some(generation)) => {
                ...
                {
                    return Err(
                        "remote factory final checkpoint-witness receipt quorum witness key generation is outside its bound"
                            .into(),
                    );
                }
            }
        ...
        for (digest, label) in [
            (
                ...
                "final checkpoint-witness receipt SHA-256",
            ),
            (
        ...
        if request_sha256.is_some_and(|request| request != member.request_sha256) {
            return Err(
                "remote factory final checkpoint-witness receipt quorum members use different requests"
                    .into(),
            );
        }
...
pub(crate) fn validate_remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint_witness_receipt_quorum_for_log(
    report: &RemoteFactoryReleaseRegistryHistoryReceiptQuorumLogCheckpointWitnessReceiptQuorumLogCheckpointWitnessReceiptQuorumReport,
    ...
    let expected_log_sha256 = report
        .final_admission_log_sha256
        .as_deref()
        .ok_or_else(|| {
            "remote factory final checkpoint-witness receipt quorum report is not bound to an admission log"
                .to_string()
        })?;
    if report.final_admission_log_id.as_deref() != Some(log.log_id.as_str())
        || report.final_admission_log_entry_count != Some(log.entries.len() as u64)
        || report.final_admission_log_head_sha256.as_deref() != log.head_sha256.as_deref()
...
pub(crate) fn sign_remote_factory_release_final_checkpoint_witness_receipt_quorum_log_checkpoint(
    report: &RemoteFactoryReleaseRegistryHistoryReceiptQuorumLogCheckpointWitnessReceiptQuorumLogCheckpointWitnessReceiptQuorumReport,
    log: &ApprovalTransparencyLog,
    signer_id: &str,
    secret_key: &[u8; 32],
) -> Result<SignedRemoteFactoryReleaseFinalCheckpointWitnessReceiptQuorumLogCheckpoint, String> {
    validate_remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint_witness_receipt_quorum_for_log(
        report, log,
    )?;
    validate_slug(
        signer_id,
        "factory final checkpoint-witness receipt quorum checkpoint signer id",
    )?;
    let report_bytes = serde_json::to_vec(report).map_err(|error| {
        format!("serializing factory final checkpoint-witness receipt quorum report: {error}")
    })?;
    let signing_key = SigningKey::from_bytes(secret_key);
    let mut checkpoint =
        SignedRemoteFactoryReleaseFinalCheckpointWitnessReceiptQuorumLogCheckpoint {
            schema_version: 1,
            final_checkpoint_witness_receipt_quorum_report_sha256: sha256(&report_bytes),
            registry_id: report.registry_id.clone(),
            generation: report.generation,
            registry_checkpoint_sha256: report.registry_checkpoint_sha256.clone(),
            receipt_quorum_checkpoint_sha256: report.receipt_quorum_checkpoint_sha256.clone(),
            checkpoint_witness_receipt_quorum_checkpoint_sha256: report.checkpoint_sha256.clone(),
            final_admission_log_id: log.log_id.clone(),
            final_admission_log_entry_count: log.entries.len() as u64,
            final_admission_log_head_sha256: log.head_sha256.clone().ok_or_else(|| {
                "quorum-bound factory final checkpoint-witness receipt approval log has no head"
                    .to_string()
            })?,
            final_admission_log_sha256: approval_transparency_log_sha256(log)?,
    ...
    let payload =
        factory_final_checkpoint_witness_receipt_quorum_log_checkpoint_payload(&checkpoint)?;
...
pub(crate) fn verify_remote_factory_release_final_checkpoint_witness_receipt_quorum_log_checkpoint(
    report: &RemoteFactoryReleaseRegistryHistoryReceiptQuorumLogCheckpointWitnessReceiptQuorumLogCheckpointWitnessReceiptQuorumReport,
    log: &ApprovalTransparencyLog,
    checkpoint: &SignedRemoteFactoryReleaseFinalCheckpointWitnessReceiptQuorumLogCheckpoint,
    trusted_public_key: &[u8; 32],
) -> Result<RemoteFactoryReleaseFinalCheckpointWitnessReceiptQuorumLogCheckpointVerification, String>
{
    ...
    if checkpoint.final_checkpoint_witness_receipt_quorum_report_sha256 != sha256(&report_bytes)
        || checkpoint.registry_id != report.registry_id
        || checkpoint.generation != report.generation
        || checkpoint.registry_checkpoint_sha256 != report.registry_checkpoint_sha256
        || checkpoint.receipt_quorum_checkpoint_sha256 != report.receipt_quorum_checkpoint_sha256
        || checkpoint.checkpoint_witness_receipt_quorum_checkpoint_sha256
            != report.checkpoint_sha256
        || checkpoint.final_admission_log_id != log.log_id
        || checkpoint.final_admission_log_entry_count != log.entries.len() as u64
        || Some(checkpoint.final_admission_log_head_sha256.as_str()) != log.head_sha256.as_deref()
        || checkpoint.final_admission_log_sha256 != approval_transparency_log_sha256(log)?
        || checkpoint.minimum_witnesses != report.minimum_witnesses
        || checkpoint.valid_witnesses != report.valid_witnesses
    {
        return Err(
            "signed factory final checkpoint-witness receipt quorum checkpoint is bound to different evidence"
                .into(),
        );
    }
    let public_key = decode_hex::<32>(
        &checkpoint.public_key,
        "factory final checkpoint-witness receipt quorum checkpoint public key",
    )?;
    if &public_key != trusted_public_key {
        return Err(
            "factory final checkpoint-witness receipt quorum checkpoint key is not trusted".into(),
        );
    }
    let signature = decode_hex::<64>(
        &checkpoint.signature,
        "factory final checkpoint-witness receipt quorum checkpoint signature",
    )?;
    VerifyingKey::from_bytes(&public_key)
        .map_err(|error| {
            format!(
                "invalid factory final checkpoint-witness receipt quorum checkpoint public key: {error}"
            )
        })?
        .verify_strict(
            &factory_final_checkpoint_witness_receipt_quorum_log_checkpoint_payload(checkpoint)?,
        ...
        .map_err(|error| {
            format!(
                "invalid factory final checkpoint-witness receipt quorum checkpoint signature: {error}"
            )
        })?;
    let verification =
        RemoteFactoryReleaseFinalCheckpointWitnessReceiptQuorumLogCheckpointVerification {
            schema_version: 1,
            final_checkpoint_witness_receipt_quorum_report_sha256: checkpoint
...
pub(crate) fn remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint_witness_receipt_json_schema()
-> Value {
    let digest = digest_schema();
    json!({
        "$schema": "https://json-schema.org/draft/2020-12/schema",
        "$id": "https://github.com/penguin425/pcbex/schema/remote-factory-release-registry-history-receipt-quorum-log-checkpoint-witness-receipt-quorum-log-checkpoint-witness-receipt-v1.json",
        "title": "pcbex remote factory checkpoint-witness receipt-quorum checkpoint witness receipt",
        "type": "object",
        "additionalProperties": false,
        "required": [
            "schema_version", "adapter", "endpoint",
            "checkpoint_witness_receipt_quorum_report_sha256",
            "checkpoint_witness_receipt_quorum_report_source_sha256",
            ...
            "admission_log_sha256", "admission_log_source_sha256",
        ...
        "properties": {
            ...
            "adapter": {"const": CHECKPOINT_WITNESS_RECEIPT_QUORUM_LOG_CHECKPOINT_WITNESS_ADAPTER},
            "endpoint": {
                "anyOf": [
            ...
            "checkpoint_witness_receipt_quorum_report_sha256": digest.clone(),
            "checkpoint_witness_receipt_quorum_report_source_sha256": digest.clone(),
            ...
            "admission_log_source_sha256": digest.clone(),
            ...
            "response_bytes": {
                ...
                "maximum": MAX_SIGNED_REMOTE_FACTORY_RELEASE_REGISTRY_HISTORY_RECEIPT_QUORUM_LOG_CHECKPOINT_WITNESS_RECEIPT_QUORUM_LOG_CHECKPOINT_WITNESS_BYTES
            },
...
pub(crate) fn remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint_witness_receipt_quorum_report_json_schema()
-> Value {
    let digest = digest_schema();
    json!({
        "$schema": "https://json-schema.org/draft/2020-12/schema",
        "$id": "https://github.com/penguin425/pcbex/schema/remote-factory-release-registry-history-receipt-quorum-log-checkpoint-witness-receipt-quorum-log-checkpoint-witness-receipt-quorum-report-v1.json",
        ...
        "properties": {
            ...
            "final_admission_log_id": {
                "oneOf": [{"type": "null"}, slug_schema()]
            },
            "final_admission_log_entry_count": {
...
pub(crate) fn signed_remote_factory_release_final_checkpoint_witness_receipt_quorum_log_checkpoint_json_schema()
-> Value {
    let digest = digest_schema();
    json!({
        "$schema": "https://json-schema.org/draft/2020-12/schema",
        "$id": "https://github.com/penguin425/pcbex/schema/signed-remote-factory-release-final-checkpoint-witness-receipt-quorum-log-checkpoint-v1.json",
        "title": "pcbex signed factory final checkpoint-witness receipt-quorum log checkpoint",
        "type": "object",
        "additionalProperties": false,
        "required": [
            "schema_version",
            ...
            "final_admission_log_id", "final_admission_log_entry_count",
            "final_admission_log_head_sha256", "final_admission_log_sha256",
            "minimum_witnesses", "valid_witnesses", "signer_id", "algorithm",
...
pub(crate) fn remote_factory_release_final_checkpoint_witness_receipt_quorum_log_checkpoint_verification_json_schema()
-> Value {
    let digest = digest_schema();
    json!({
        "$schema": "https://json-schema.org/draft/2020-12/schema",
        "$id": "https://github.com/penguin425/pcbex/schema/remote-factory-release-final-checkpoint-witness-receipt-quorum-log-checkpoint-verification-v1.json",
        "title": "pcbex factory final checkpoint-witness receipt-quorum log checkpoint verification",
        "type": "object",
        "additionalProperties": false,
        "required": [
            "schema_version",
...
pub(crate) fn signed_remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint_json_schema()
-> Value {
    let digest = digest_schema();
    json!({
        "$schema": "https://json-schema.org/draft/2020-12/schema",
        "$id": "https://github.com/penguin425/pcbex/schema/signed-remote-factory-release-registry-history-receipt-quorum-log-checkpoint-witness-receipt-quorum-log-checkpoint-v1.json",
        "title": "pcbex signed factory checkpoint-witness receipt-quorum log checkpoint",
        "type": "object",
        "additionalProperties": false,
        "required": [
            "schema_version", "checkpoint_witness_receipt_quorum_report_sha256",
            "registry_id", "generation", "registry_checkpoint_sha256",
            "receipt_quorum_checkpoint_sha256", "admission_log_id",
            "admission_log_entry_count", "admission_log_head_sha256",
            "admission_log_sha256", "minimum_witnesses", "valid_witnesses",
...
pub(crate) fn remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint_verification_json_schema()
-> Value {
    let digest = digest_schema();
    json!({
        "$schema": "https://json-schema.org/draft/2020-12/schema",
        "$id": "https://github.com/penguin425/pcbex/schema/remote-factory-release-registry-history-receipt-quorum-log-checkpoint-witness-receipt-quorum-log-checkpoint-verification-v1.json",
        "title": "pcbex factory checkpoint-witness receipt-quorum log checkpoint verification",
        "type": "object",
        "additionalProperties": false,
        "required": [
            "schema_version", "checkpoint_witness_receipt_quorum_report_sha256",
            "registry_id", "generation", "receipt_quorum_checkpoint_sha256",
            "admission_log_id", "admission_log_entry_count",
            "admission_log_head_sha256", "admission_log_sha256", "signer_id",
            "public_key", "verified"
        ],
        "properties": {
            "schema_version": {"const": 1},
...
pub(crate) fn remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint_witness_trust_state_json_schema()
-> Value {
    let digest = digest_schema();
    json!({
        "$schema": "https://json-schema.org/draft/2020-12/schema",
        "$id": "https://github.com/penguin425/pcbex/schema/remote-factory-release-registry-history-receipt-quorum-log-checkpoint-witness-receipt-quorum-log-checkpoint-witness-trust-state-v1.json",
        "title": "pcbex generation-chained factory checkpoint-witness receipt-quorum checkpoint witness trust state",
        "type": "object",
        "additionalProperties": false,
        "required": [
...
pub(crate) fn signed_remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint_witness_key_rotation_json_schema()
-> Value {
    let digest = digest_schema();
    json!({
        "$schema": "https://json-schema.org/draft/2020-12/schema",
        "$id": "https://github.com/penguin425/pcbex/schema/signed-remote-factory-release-registry-history-receipt-quorum-log-checkpoint-witness-receipt-quorum-log-checkpoint-witness-key-rotation-v1.json",
        "title": "pcbex dual-signed factory checkpoint-witness receipt-quorum checkpoint witness key rotation",
        "type": "object",
        "additionalProperties": false,
        "required": [
...
pub(crate) fn sign_remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint(
    report: &RemoteFactoryReleaseRegistryHistoryReceiptQuorumLogCheckpointWitnessReceiptQuorumReport,
    log: &ApprovalTransparencyLog,
    signer_id: &str,
    secret_key: &[u8; 32],
...
>{
    ...
    validate_slug(
        signer_id,
        "factory checkpoint-witness receipt quorum checkpoint signer id",
    )?;
    let report_bytes = serde_json::to_vec(report).map_err(|error| {
        format!("serializing factory checkpoint-witness receipt quorum report: {error}")
    })?;
    let signing_key = SigningKey::from_bytes(secret_key);
    let mut checkpoint = SignedRemoteFactoryReleaseRegistryHistoryReceiptQuorumLogCheckpointWitnessReceiptQuorumLogCheckpoint {
        schema_version: 1,
        checkpoint_witness_receipt_quorum_report_sha256: sha256(&report_bytes),
        registry_id: report.registry_id.clone(),
        generation: report.generation,
        registry_checkpoint_sha256: report.registry_checkpoint_sha256.clone(),
        receipt_quorum_checkpoint_sha256: report.checkpoint_sha256.clone(),
        admission_log_id: log.log_id.clone(),
        admission_log_entry_count: log.entries.len() as u64,
        admission_log_head_sha256: log.head_sha256.clone().ok_or_else(|| {
            "quorum-bound factory checkpoint-witness receipt approval log has no head".to_string()
        })?,
        admission_log_sha256: approval_transparency_log_sha256(log)?,
        minimum_witnesses: report.minimum_witnesses,
        valid_witnesses: report.valid_witnesses,
        signer_id: signer_id.to_string(),
        algorithm: "ed25519".into(),
    ...
    let payload = factory_checkpoint_witness_receipt_quorum_log_checkpoint_payload(&checkpoint)?;
    checkpoint.signature = hex::encode(signing_key.sign(&payload).to_bytes());
    validate_signed_remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint(
        &checkpoint,
    )?;
...
pub(crate) fn verify_remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint(
    report: &RemoteFactoryReleaseRegistryHistoryReceiptQuorumLogCheckpointWitnessReceiptQuorumReport,
    log: &ApprovalTransparencyLog,
    checkpoint: &SignedRemoteFactoryReleaseRegistryHistoryReceiptQuorumLogCheckpointWitnessReceiptQuorumLogCheckpoint,
    trusted_public_key: &[u8; 32],
...
>{
    ...
    if checkpoint.checkpoint_witness_receipt_quorum_report_sha256 != sha256(&report_bytes)
        || checkpoint.registry_id != report.registry_id
        || checkpoint.generation != report.generation
        || checkpoint.registry_checkpoint_sha256 != report.registry_checkpoint_sha256
        || checkpoint.receipt_quorum_checkpoint_sha256 != report.checkpoint_sha256
        || checkpoint.admission_log_id != log.log_id
        || checkpoint.admission_log_entry_count != log.entries.len() as u64
        || Some(checkpoint.admission_log_head_sha256.as_str()) != log.head_sha256.as_deref()
        || checkpoint.admission_log_sha256 != approval_transparency_log_sha256(log)?
        || checkpoint.minimum_witnesses != report.minimum_witnesses
        || checkpoint.valid_witnesses != report.valid_witnesses
    {
        return Err(
            "signed factory checkpoint-witness receipt quorum checkpoint is bound to different evidence"
                .into(),
        );
    }
    let public_key = decode_hex::<32>(
    ...
    if &public_key != trusted_public_key {
        return Err(
            "factory checkpoint-witness receipt quorum checkpoint key is not trusted".into(),
        );
    }
    let signature = decode_hex::<64>(
        &checkpoint.signature,
        "factory checkpoint-witness receipt quorum checkpoint signature",
    )?;
    VerifyingKey::from_bytes(&public_key)
        .map_err(|error| {
            format!(
                "invalid factory checkpoint-witness receipt quorum checkpoint public key: {error}"
            )
        })?
        .verify_strict(
            &factory_checkpoint_witness_receipt_quorum_log_checkpoint_payload(checkpoint)?,
            &Signature::from_bytes(&signature),
        )
        .map_err(|error| {
            format!(
                "invalid factory checkpoint-witness receipt quorum checkpoint signature: {error}"
            )
        })?;
    let verification = RemoteFactoryReleaseRegistryHistoryReceiptQuorumLogCheckpointWitnessReceiptQuorumLogCheckpointVerification {
        schema_version: 1,
        checkpoint_witness_receipt_quorum_report_sha256: checkpoint
            .checkpoint_witness_receipt_quorum_report_sha256
            .clone(),
        registry_id: checkpoint.registry_id.clone(),
        generation: checkpoint.generation,
...
pub(crate) fn new_remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint_witness_trust_state(
    witness_id: &str,
    public_key: &[u8; 32],
) -> Result<
    RemoteFactoryReleaseRegistryHistoryReceiptQuorumLogCheckpointWitnessReceiptQuorumLogCheckpointWitnessTrustState,
    String,
>{
    let state = RemoteFactoryReleaseRegistryHistoryReceiptQuorumLogCheckpointWitnessReceiptQuorumLogCheckpointWitnessTrustState {
        schema_version: 1,
...
pub(crate) fn remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint_witness_trusted_public_key(
    state: &RemoteFactoryReleaseRegistryHistoryReceiptQuorumLogCheckpointWitnessReceiptQuorumLogCheckpointWitnessTrustState,
) -> Result<[u8; 32], String> {
    validate_remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint_witness_trust_state(
        state,
    ...
    decode_hex::<32>(
        ...
        "current factory checkpoint-witness receipt quorum checkpoint witness public key",
    )
}

pub(crate) fn sign_remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint_witness_key_rotation(
    state: &RemoteFactoryReleaseRegistryHistoryReceiptQuorumLogCheckpointWitnessReceiptQuorumLogCheckpointWitnessTrustState,
...
>{
    ...
    if rotated_at_unix > MAX_TIMESTAMP {
        return Err(
            "factory checkpoint-witness receipt quorum checkpoint witness rotation time exceeds its bound"
                .into(),
        );
    }
    ...
    validate_nonweak_public_key(
        ...
        "old factory checkpoint-witness receipt quorum checkpoint witness key",
    )?;
    validate_nonweak_public_key(
        &new_public_key_bytes,
        "new factory checkpoint-witness receipt quorum checkpoint witness key",
    )?;
    ...
    if old_public_key != state.current_public_key {
        return Err(
            "old factory checkpoint-witness receipt quorum checkpoint witness key is not currently trusted"
                .into(),
        );
    }
    if new_public_key == old_public_key {
        return Err(
            "new factory checkpoint-witness receipt quorum checkpoint witness key must differ"
                .into(),
        );
    }
    if state
    ...
    {
        return Err(
            "factory checkpoint-witness receipt quorum checkpoint witness rotation time moved backwards"
                .into(),
        );
    }
    let to_generation = state
        ...
        .ok_or_else(|| {
            "factory checkpoint-witness receipt quorum checkpoint witness generation overflow"
                .to_string()
        })?;
    let mut rotation = SignedRemoteFactoryReleaseRegistryHistoryReceiptQuorumLogCheckpointWitnessReceiptQuorumLogCheckpointWitnessKeyRotation {
        schema_version: 1,
    ...
    let payload =
        factory_checkpoint_witness_receipt_quorum_log_checkpoint_witness_key_rotation_payload(
            &rotation,
        )?;
...
pub(crate) fn apply_remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint_witness_key_rotation(
    state: &RemoteFactoryReleaseRegistryHistoryReceiptQuorumLogCheckpointWitnessReceiptQuorumLogCheckpointWitnessTrustState,
    rotation: &SignedRemoteFactoryReleaseRegistryHistoryReceiptQuorumLogCheckpointWitnessReceiptQuorumLogCheckpointWitnessKeyRotation,
) -> Result<
    RemoteFactoryReleaseRegistryHistoryReceiptQuorumLogCheckpointWitnessReceiptQuorumLogCheckpointWitnessTrustState,
...
>{
    ...
    {
        return Err(
            "factory checkpoint-witness receipt quorum checkpoint witness rotation does not extend retained trust"
                .into(),
        );
    }
    let next = RemoteFactoryReleaseRegistryHistoryReceiptQuorumLogCheckpointWitnessReceiptQuorumLogCheckpointWitnessTrustState {
        schema_version: 1,
        witness_id: state.witness_id.clone(),
        generation: rotation.to_generation,
        current_public_key: rotation.new_public_key.clone(),
        last_rotation_sha256: Some(
            signed_remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint_witness_key_rotation_sha256(
                rotation,
            )?,
        ),
...
>{
    ...
    verify_remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint_witnesses_after_checkpoint_verification(
        report,
        checkpoint,
        trusted_checkpoint_public_key,
        witnesses,
...
#[allow(clippy::too_many_arguments)]
fn verify_remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint_witnesses_after_checkpoint_verification(
    report: &RemoteFactoryReleaseRegistryHistoryReceiptQuorumLogCheckpointWitnessReceiptQuorumReport,
    checkpoint: &SignedRemoteFactoryReleaseRegistryHistoryReceiptQuorumLogCheckpointWitnessReceiptQuorumLogCheckpoint,
    trusted_checkpoint_public_key: &[u8; 32],
    witnesses: &[SignedRemoteFactoryReleaseRegistryHistoryReceiptQuorumLogCheckpointWitnessReceiptQuorumLogCheckpointWitness],
...
#[allow(clippy::too_many_arguments)]
pub(crate) fn verify_remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint_witnesses_with_trust_states(
    report: &RemoteFactoryReleaseRegistryHistoryReceiptQuorumLogCheckpointWitnessReceiptQuorumReport,
    log: &ApprovalTransparencyLog,
    checkpoint: &SignedRemoteFactoryReleaseRegistryHistoryReceiptQuorumLogCheckpointWitnessReceiptQuorumLogCheckpoint,
    trusted_checkpoint_public_key: &[u8; 32],
    witnesses: &[SignedRemoteFactoryReleaseRegistryHistoryReceiptQuorumLogCheckpointWitnessReceiptQuorumLogCheckpointWitness],
    witness_trust_states: &[RemoteFactoryReleaseRegistryHistoryReceiptQuorumLogCheckpointWitnessReceiptQuorumLogCheckpointWitnessTrustState],
    minimum_witnesses: u32,
    evaluated_at_unix: u64,
) -> Result<
    RemoteFactoryReleaseRegistryHistoryReceiptQuorumLogCheckpointWitnessReceiptQuorumLogCheckpointWitnessQuorumReport,
...
>{
    ...
    {
        return Err(
            "factory checkpoint-witness receipt quorum checkpoint witnesses and trust states must be paired and bounded"
                .into(),
        );
    }
    for (witness, state) in witnesses.iter().zip(witness_trust_states) {
        ...
        if witness.witness_id != state.witness_id {
            return Err(
                "factory checkpoint-witness receipt quorum checkpoint witness identity does not match retained trust"
                    .into(),
            );
        }
    }
    let trusted_keys = witness_trust_states
        .iter()
        .map(
            remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint_witness_trusted_public_key,
        )
...
pub(crate) fn validate_signed_remote_factory_release_final_checkpoint_witness_receipt_quorum_log_checkpoint(
    checkpoint: &SignedRemoteFactoryReleaseFinalCheckpointWitnessReceiptQuorumLogCheckpoint,
) -> Result<(), String> {
    if checkpoint.schema_version != 1
        ...
        || checkpoint.generation
            > MAX_FACTORY_RELEASE_STATE_TRANSPARENCY_EXTERNAL_GOSSIP_REGISTRY_GENERATION
        || checkpoint.final_admission_log_entry_count < 2
        || !(2..=MAX_FACTORY_RELEASE_STATE_TRANSPARENCY_EXTERNAL_GOSSIP_ORGANIZATION_REGISTRY_HISTORY_CHECKPOINT_WITNESSES as u32)
    ...
    {
        return Err(
            "signed factory final checkpoint-witness receipt quorum checkpoint invariants are invalid"
                .into(),
        );
    }
    validate_slug(&checkpoint.registry_id, "factory release registry id")?;
    validate_slug(
        &checkpoint.final_admission_log_id,
    ...
    for (digest, label) in [
        ...
        (
            &checkpoint.final_admission_log_head_sha256,
...
pub(crate) fn validate_signed_remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint(
    checkpoint: &SignedRemoteFactoryReleaseRegistryHistoryReceiptQuorumLogCheckpointWitnessReceiptQuorumLogCheckpoint,
) -> Result<(), String> {
    if checkpoint.schema_version != 1
        || checkpoint.algorithm != "ed25519"
        || checkpoint.generation
            > MAX_FACTORY_RELEASE_STATE_TRANSPARENCY_EXTERNAL_GOSSIP_REGISTRY_GENERATION
        || checkpoint.admission_log_entry_count < 2
        || !(2..=MAX_FACTORY_RELEASE_STATE_TRANSPARENCY_EXTERNAL_GOSSIP_ORGANIZATION_REGISTRY_HISTORY_CHECKPOINT_WITNESSES as u32)
            .contains(&checkpoint.minimum_witnesses)
        || !(2..=MAX_FACTORY_RELEASE_STATE_TRANSPARENCY_EXTERNAL_GOSSIP_ORGANIZATION_REGISTRY_HISTORY_CHECKPOINT_WITNESSES as u32)
            .contains(&checkpoint.valid_witnesses)
    ...
    {
        return Err(
            "signed factory checkpoint-witness receipt quorum checkpoint invariants are invalid"
                .into(),
        );
    }
    validate_slug(&checkpoint.registry_id, "factory release registry id")?;
    validate_slug(
        &checkpoint.admission_log_id,
    ...
    for (digest, label) in [
        ...
        (
            &checkpoint.admission_log_head_sha256,
            "admission log head SHA-256",
        ),
        (&checkpoint.admission_log_sha256, "admission log SHA-256"),
    ] {
        validate_digest(digest, label)?;
    }
    let public_key = decode_hex::<32>(
...
pub(crate) fn validate_remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint_witness_trust_state(
    state: &RemoteFactoryReleaseRegistryHistoryReceiptQuorumLogCheckpointWitnessReceiptQuorumLogCheckpointWitnessTrustState,
) -> Result<(), String> {
    ...
    {
        return Err(
            "factory checkpoint-witness receipt quorum checkpoint witness trust-state invariants are invalid"
                .into(),
        );
    }
    validate_slug(
    ...
    match (
        ...
        (0, None, None) => Ok(()),
        (0, _, _) => Err(
            "initial factory checkpoint-witness receipt quorum checkpoint witness trust state references rotation"
                .into(),
        ),
        (_, Some(digest), Some(_)) => validate_digest(
            digest,
            "factory checkpoint-witness receipt quorum checkpoint witness rotation SHA-256",
        ),
        _ => Err(
            "rotated factory checkpoint-witness receipt quorum checkpoint witness trust state is incomplete"
                .into(),
        ),
    }
}

pub(crate) fn validate_signed_remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint_witness_key_rotation(
    rotation: &SignedRemoteFactoryReleaseRegistryHistoryReceiptQuorumLogCheckpointWitnessReceiptQuorumLogCheckpointWitnessKeyRotation,
) -> Result<(), String> {
    ...
    {
        return Err(
            "factory checkpoint-witness receipt quorum checkpoint witness key-rotation invariants are invalid"
                .into(),
        );
    }
    validate_slug(
    ...
    match (rotation.from_generation, &rotation.previous_rotation_sha256) {
        ...
        (0, Some(_)) => {
            return Err(
                "initial factory checkpoint-witness receipt quorum checkpoint witness rotation cannot reference a predecessor"
                    .into(),
            );
        }
        (_, Some(digest)) => validate_digest(
            digest,
            "previous factory checkpoint-witness receipt quorum checkpoint witness rotation SHA-256",
        )?,
        (_, None) => {
            return Err(
                "advanced factory checkpoint-witness receipt quorum checkpoint witness rotation requires predecessor evidence"
                    .into(),
            );
        }
    }
    let old_key = decode_hex::<32>(
        ...
        "old factory checkpoint-witness receipt quorum checkpoint witness public key",
    )?;
    let new_key = decode_hex::<32>(
        &rotation.new_public_key,
        "new factory checkpoint-witness receipt quorum checkpoint witness public key",
    )?;
    validate_nonweak_public_key(
        &old_key,
        "old factory checkpoint-witness receipt quorum checkpoint witness public key",
    ...
    for (key, signature, label) in [
        (
            ...
            "old factory checkpoint-witness receipt quorum checkpoint witness rotation",
        ),
        (
            &new_key,
            &rotation.new_signature,
            "new factory checkpoint-witness receipt quorum checkpoint witness rotation",
        ),
    ] {
...
fn signed_remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint_witness_key_rotation_sha256(
    rotation: &SignedRemoteFactoryReleaseRegistryHistoryReceiptQuorumLogCheckpointWitnessReceiptQuorumLogCheckpointWitnessKeyRotation,
) -> Result<String, String> {
    validate_signed_remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint_witness_key_rotation(
        rotation,
    ...
    serde_json::to_vec(rotation)
        ...
        .map_err(|error| {
            format!(
                "serializing factory checkpoint-witness receipt quorum checkpoint witness rotation: {error}"
            )
        })
}
...
fn validate_remote_factory_release_final_checkpoint_witness_receipt_quorum_log_checkpoint_verification(
    verification: &RemoteFactoryReleaseFinalCheckpointWitnessReceiptQuorumLogCheckpointVerification,
) -> Result<(), String> {
    if verification.schema_version != 1
        ...
        || verification.generation
            > MAX_FACTORY_RELEASE_STATE_TRANSPARENCY_EXTERNAL_GOSSIP_REGISTRY_GENERATION
        || verification.final_admission_log_entry_count < 2
    {
        return Err(
            "factory final checkpoint-witness receipt quorum checkpoint verification invariants are invalid"
                .into(),
        );
    }
    validate_slug(&verification.registry_id, "factory release registry id")?;
    validate_slug(
        &verification.final_admission_log_id,
        "factory final checkpoint-witness receipt admission log id",
    )?;
    validate_slug(
    ...
    for (digest, label) in [
        (
            &verification.final_checkpoint_witness_receipt_quorum_report_sha256,
            "final checkpoint-witness receipt quorum report SHA-256",
        ),
        (
            &verification.checkpoint_witness_receipt_quorum_checkpoint_sha256,
            "factory checkpoint-witness receipt quorum checkpoint SHA-256",
        ),
        (
            &verification.final_admission_log_head_sha256,
            "final admission log head SHA-256",
        ),
        (
            &verification.final_admission_log_sha256,
            "final admission log SHA-256",
        ),
    ] {
        validate_digest(digest, label)?;
...
fn validate_remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint_verification(
    verification: &RemoteFactoryReleaseRegistryHistoryReceiptQuorumLogCheckpointWitnessReceiptQuorumLogCheckpointVerification,
) -> Result<(), String> {
    if verification.schema_version != 1
        || !verification.verified
        || verification.generation
            > MAX_FACTORY_RELEASE_STATE_TRANSPARENCY_EXTERNAL_GOSSIP_REGISTRY_GENERATION
        || verification.admission_log_entry_count < 2
    {
        return Err(
            "factory checkpoint-witness receipt quorum checkpoint verification invariants are invalid"
                .into(),
        );
    }
    validate_slug(&verification.registry_id, "factory release registry id")?;
    validate_slug(
        &verification.admission_log_id,
        "factory checkpoint-witness receipt admission log id",
    )?;
    validate_slug(
        &verification.signer_id,
    ...
    for (digest, label) in [
        (
            &verification.checkpoint_witness_receipt_quorum_report_sha256,
            "checkpoint-witness receipt quorum report SHA-256",
        ),
        (
            &verification.receipt_quorum_checkpoint_sha256,
            "factory receipt quorum checkpoint SHA-256",
        ),
        (
            &verification.admission_log_head_sha256,
            "admission log head SHA-256",
        ),
        (&verification.admission_log_sha256, "admission log SHA-256"),
    ] {
        validate_digest(digest, label)?;
    }
    let public_key = decode_hex::<32>(
...
fn factory_final_checkpoint_witness_receipt_quorum_log_checkpoint_payload(
    checkpoint: &SignedRemoteFactoryReleaseFinalCheckpointWitnessReceiptQuorumLogCheckpoint,
) -> Result<Vec<u8>, String> {
    let body = json!({
        "schema_version": checkpoint.schema_version,
        "final_checkpoint_witness_receipt_quorum_report_sha256": checkpoint.final_checkpoint_witness_receipt_quorum_report_sha256,
        "registry_id": checkpoint.registry_id,
        "generation": checkpoint.generation,
        "registry_checkpoint_sha256": checkpoint.registry_checkpoint_sha256,
        "receipt_quorum_checkpoint_sha256": checkpoint.receipt_quorum_checkpoint_sha256,
        "checkpoint_witness_receipt_quorum_checkpoint_sha256": checkpoint.checkpoint_witness_receipt_quorum_checkpoint_sha256,
        "final_admission_log_id": checkpoint.final_admission_log_id,
        "final_admission_log_entry_count": checkpoint.final_admission_log_entry_count,
        "final_admission_log_head_sha256": checkpoint.final_admission_log_head_sha256,
        "final_admission_log_sha256": checkpoint.final_admission_log_sha256,
    ...
    let mut payload = FINAL_CHECKPOINT_WITNESS_RECEIPT_QUORUM_LOG_CHECKPOINT_DOMAIN
        .as_bytes()
        .to_vec();
    payload.push(0);
    payload.extend(serde_json::to_vec(&body).map_err(|error| {
        format!(
            "serializing factory final checkpoint-witness receipt quorum checkpoint payload: {error}"
        )
    })?);
    Ok(payload)
}

fn factory_checkpoint_witness_receipt_quorum_log_checkpoint_payload(
    checkpoint: &SignedRemoteFactoryReleaseRegistryHistoryReceiptQuorumLogCheckpointWitnessReceiptQuorumLogCheckpoint,
) -> Result<Vec<u8>, String> {
    let body = json!({
        "schema_version": checkpoint.schema_version,
        "checkpoint_witness_receipt_quorum_report_sha256": checkpoint.checkpoint_witness_receipt_quorum_report_sha256,
        "registry_id": checkpoint.registry_id,
        "generation": checkpoint.generation,
        "registry_checkpoint_sha256": checkpoint.registry_checkpoint_sha256,
        "receipt_quorum_checkpoint_sha256": checkpoint.receipt_quorum_checkpoint_sha256,
        "admission_log_id": checkpoint.admission_log_id,
        "admission_log_entry_count": checkpoint.admission_log_entry_count,
        "admission_log_head_sha256": checkpoint.admission_log_head_sha256,
        "admission_log_sha256": checkpoint.admission_log_sha256,
        "minimum_witnesses": checkpoint.minimum_witnesses,
        "valid_witnesses": checkpoint.valid_witnesses,
        "signer_id": checkpoint.signer_id,
        "algorithm": checkpoint.algorithm
    });
    let mut payload = CHECKPOINT_WITNESS_RECEIPT_QUORUM_LOG_CHECKPOINT_DOMAIN
        .as_bytes()
        .to_vec();
    payload.push(0);
    payload.extend(serde_json::to_vec(&body).map_err(|error| {
...
fn factory_checkpoint_witness_receipt_quorum_log_checkpoint_witness_key_rotation_payload(
    rotation: &SignedRemoteFactoryReleaseRegistryHistoryReceiptQuorumLogCheckpointWitnessReceiptQuorumLogCheckpointWitnessKeyRotation,
) -> Result<Vec<u8>, String> {
    let body = json!({
    ...
    let mut payload = CHECKPOINT_WITNESS_RECEIPT_QUORUM_LOG_CHECKPOINT_WITNESS_KEY_ROTATION_DOMAIN
        .as_bytes()
        .to_vec();
    payload.push(0);
    payload.extend(serde_json::to_vec(&body).map_err(|error| {
...
mod tests {
    ...
    #[test]
    fn round_trips_only_exact_remote_final_checkpoint_witness_receipts() {
        let checkpoint_public_key = hex::encode(
            SigningKey::from_bytes(&[108; 32])
                .verifying_key()
                .to_bytes(),
        );
        let witness_public_key = hex::encode(
        ...
        let receipt = RemoteFactoryReleaseRegistryHistoryReceiptQuorumLogCheckpointWitnessReceiptQuorumLogCheckpointWitnessReceipt {
            schema_version: 1,
            adapter: CHECKPOINT_WITNESS_RECEIPT_QUORUM_LOG_CHECKPOINT_WITNESS_ADAPTER.into(),
            endpoint: "https://witness.example/v1/factory-final-checkpoint".into(),
            checkpoint_witness_receipt_quorum_report_sha256: "1".repeat(64),
            checkpoint_witness_receipt_quorum_report_source_sha256: "2".repeat(64),
            registry_id: "factory-registry".into(),
            generation: 5,
            registry_checkpoint_sha256: "3".repeat(64),
            receipt_quorum_checkpoint_sha256: "4".repeat(64),
            admission_log_id: "factory-receipts".into(),
            admission_log_entry_count: 2,
            admission_log_head_sha256: "5".repeat(64),
            admission_log_sha256: "6".repeat(64),
            admission_log_source_sha256: "7".repeat(64),
            checkpoint_sha256: "8".repeat(64),
            checkpoint_source_sha256: "9".repeat(64),
            checkpoint_public_key: checkpoint_public_key.clone(),
            request_sha256: "a".repeat(64),
            response_sha256: "b".repeat(64),
            response_bytes: 512,
            witness_sha256: "c".repeat(64),
            evaluated_at_unix: 1_000,
        ...
        let source = render_remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint_witness_receipt(
            &receipt,
        )
        .unwrap();
        assert_eq!(
        ...
        assert_eq!(
            remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint_witness_receipt_json_schema(
            )["additionalProperties"],
            false
        );
        assert!(
        ...
        let mut trusted = receipt.clone();
        trusted.witness_key_trust_state_sha256 = Some("d".repeat(64));
        trusted.witness_key_generation = Some(3);
        assert!(
            validate_remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint_witness_receipt(
                &trusted,
        ...
        stale.evaluated_at_unix = stale.witnessed_at_unix + 86_401;
        assert!(
            validate_remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint_witness_receipt(
                &stale,
            )
        ...
        let members = vec![
            RemoteFactoryReleaseRegistryHistoryReceiptQuorumLogCheckpointWitnessReceiptQuorumLogCheckpointWitnessReceiptQuorumMember {
                ...
                witness_key_trust_state_sha256: None,
                witness_key_generation: None,
                receipt_sha256: sha256(&serde_json::to_vec(&receipt).unwrap()),
                request_sha256: receipt.request_sha256.clone(),
                response_sha256: receipt.response_sha256.clone(),
                witness_sha256: receipt.witness_sha256.clone(),
                witnessed_at_unix: receipt.witnessed_at_unix,
            ...
            RemoteFactoryReleaseRegistryHistoryReceiptQuorumLogCheckpointWitnessReceiptQuorumLogCheckpointWitnessReceiptQuorumMember {
                ...
                witness_sha256: "f".repeat(64),
                witnessed_at_unix: 998,
            },
        ];
        let report = RemoteFactoryReleaseRegistryHistoryReceiptQuorumLogCheckpointWitnessReceiptQuorumLogCheckpointWitnessReceiptQuorumReport {
            schema_version: 1,
            checkpoint_witness_receipt_quorum_report_sha256: receipt
                .checkpoint_witness_receipt_quorum_report_sha256
                .clone(),
            checkpoint_witness_receipt_quorum_report_source_sha256: receipt
                .checkpoint_witness_receipt_quorum_report_source_sha256
                .clone(),
            registry_id: receipt.registry_id.clone(),
            generation: receipt.generation,
            registry_checkpoint_sha256: receipt.registry_checkpoint_sha256.clone(),
            receipt_quorum_checkpoint_sha256: receipt
                .receipt_quorum_checkpoint_sha256
                .clone(),
            admission_log_id: receipt.admission_log_id.clone(),
            admission_log_entry_count: receipt.admission_log_entry_count,
            admission_log_head_sha256: receipt.admission_log_head_sha256.clone(),
            admission_log_sha256: receipt.admission_log_sha256.clone(),
            admission_log_source_sha256: receipt.admission_log_source_sha256.clone(),
            checkpoint_sha256: receipt.checkpoint_sha256.clone(),
            checkpoint_source_sha256: receipt.checkpoint_source_sha256.clone(),
            checkpoint_public_key: receipt.checkpoint_public_key.clone(),
            evaluated_at_unix: receipt.evaluated_at_unix,
            minimum_witnesses: 2,
            valid_witnesses: 2,
            members,
            quorum_met: true,
        ...
        let report_source = render_remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint_witness_receipt_quorum_report(
            &report,
        )
        .unwrap();
        assert_eq!(
        ...
        assert_eq!(
            remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint_witness_receipt_quorum_report_json_schema(
            )["additionalProperties"],
            false
        );
        assert!(
        ...
        let mut final_log = new_approval_transparency_log("final-witness-receipts").unwrap();
        for member in &report.members {
            append_approval_transparency_event(
                &mut final_log,
                ApprovalEventDescriptor {
                    artifact_kind: ApprovalArtifactKind::RemoteFactoryReleaseRegistryHistoryReceiptQuorumLogCheckpointWitnessReceiptQuorumLogCheckpointWitnessReceipt,
        ...
        let mut bound_report = report.clone();
        bound_report.final_admission_log_id = Some(final_log.log_id.clone());
        bound_report.final_admission_log_entry_count = Some(final_log.entries.len() as u64);
        bound_report.final_admission_log_head_sha256 = final_log.head_sha256.clone();
        bound_report.final_admission_log_sha256 =
            Some(approval_transparency_log_sha256(&final_log).unwrap());
        assert!(
            validate_remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint_witness_receipt_quorum_for_log(
                &bound_report,
                &final_log,
        ...
        let final_checkpoint_key = SigningKey::from_bytes(&[111; 32]);
        let final_checkpoint =
            sign_remote_factory_release_final_checkpoint_witness_receipt_quorum_log_checkpoint(
                &bound_report,
                &final_log,
                "factory-final-receipt-quorum",
                &final_checkpoint_key.to_bytes(),
            )
            .unwrap();
        assert_eq!(
            final_checkpoint.final_checkpoint_witness_receipt_quorum_report_sha256,
            sha256(&serde_json::to_vec(&bound_report).unwrap())
        );
        assert_eq!(
            final_checkpoint.checkpoint_witness_receipt_quorum_checkpoint_sha256,
            bound_report.checkpoint_sha256
        );
        assert_eq!(
            final_checkpoint.receipt_quorum_checkpoint_sha256,
            bound_report.receipt_quorum_checkpoint_sha256
        );
        let final_checkpoint_source =
            render_signed_remote_factory_release_final_checkpoint_witness_receipt_quorum_log_checkpoint(
                &final_checkpoint,
            )
            .unwrap();
        assert_eq!(
        ...
        let final_verification_source =
            render_remote_factory_release_final_checkpoint_witness_receipt_quorum_log_checkpoint_verification(
                &final_verification,
            )
            .unwrap();
        assert_eq!(
            parse_remote_factory_release_final_checkpoint_witness_receipt_quorum_log_checkpoint_verification(
                &final_verification_source,
            )
            .unwrap(),
            final_verification
        );
        assert_eq!(
            signed_remote_factory_release_final_checkpoint_witness_receipt_quorum_log_checkpoint_json_schema(
            )["additionalProperties"],
            false
        );
        assert_eq!(
            remote_factory_release_final_checkpoint_witness_receipt_quorum_log_checkpoint_verification_json_schema(
            )["additionalProperties"],
            false
        );

        let mut wrong_domain = final_checkpoint.clone();
        let mut wrong_domain_payload =
            factory_final_checkpoint_witness_receipt_quorum_log_checkpoint_payload(&wrong_domain)
                .unwrap();
        wrong_domain_payload.splice(
            ..FINAL_CHECKPOINT_WITNESS_RECEIPT_QUORUM_LOG_CHECKPOINT_DOMAIN.len(),
            CHECKPOINT_WITNESS_RECEIPT_QUORUM_LOG_CHECKPOINT_DOMAIN
                .as_bytes()
                .iter()
                .copied(),
        );
        wrong_domain.signature =
            hex::encode(final_checkpoint_key.sign(&wrong_domain_payload).to_bytes());
        assert!(
            verify_remote_factory_release_final_checkpoint_witness_receipt_quorum_log_checkpoint(
                &bound_report,
                &final_log,
        ...
        let mut substituted_parent = final_checkpoint.clone();
        substituted_parent.checkpoint_witness_receipt_quorum_checkpoint_sha256 = "0".repeat(64);
        assert!(
            verify_remote_factory_release_final_checkpoint_witness_receipt_quorum_log_checkpoint(
                &bound_report,
                &final_log,
        ...
        let mut duplicate_response = report.clone();
        duplicate_response.members[1].response_sha256 =
            duplicate_response.members[0].response_sha256.clone();
        assert!(
            validate_remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint_witness_receipt_quorum_report(
                &duplicate_response,
            )
        ...
        let mut mixed_trust = report.clone();
        mixed_trust.members[0].witness_key_trust_state_sha256 = Some("0".repeat(64));
        mixed_trust.members[0].witness_key_generation = Some(1);
        assert!(
            validate_remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint_witness_receipt_quorum_report(
                &mixed_trust,
            )
        ...
        let mut incomplete_log_binding = report;
        incomplete_log_binding.final_admission_log_id = Some("final-receipts".into());
        assert!(
            validate_remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint_witness_receipt_quorum_report(
                &incomplete_log_binding,
            )
            .is_err()
        );
    ...
    fn binds_only_the_exact_factory_receipt_quorum_log_and_suffix() {
        ...
        let checkpoint_witness_receipt_quorum_checkpoint =
        ...
        assert_eq!(
            checkpoint_witness_receipt_quorum_checkpoint
                .checkpoint_witness_receipt_quorum_report_sha256,
            sha256(&serde_json::to_vec(&admission_report).unwrap())
        );
        assert_eq!(
            checkpoint_witness_receipt_quorum_checkpoint.receipt_quorum_checkpoint_sha256,
            admission_report.checkpoint_sha256
        );
        let checkpoint_witness_receipt_quorum_checkpoint_source =
            render_signed_remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint(
                &checkpoint_witness_receipt_quorum_checkpoint,
            )
            .unwrap();
        assert_eq!(
            parse_signed_remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint(
                &checkpoint_witness_receipt_quorum_checkpoint_source,
            )
            .unwrap(),
            checkpoint_witness_receipt_quorum_checkpoint
        );
        let checkpoint_witness_receipt_quorum_verification =
            verify_remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint(
                &admission_report,
                &admission_log,
                &checkpoint_witness_receipt_quorum_checkpoint,
            ...
            .unwrap();
        assert!(checkpoint_witness_receipt_quorum_verification.verified);
        let checkpoint_witness_receipt_quorum_verification_source =
            render_remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint_verification(
                &checkpoint_witness_receipt_quorum_verification,
            )
            .unwrap();
        assert_eq!(
            parse_remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint_verification(
                &checkpoint_witness_receipt_quorum_verification_source,
            )
            .unwrap(),
            checkpoint_witness_receipt_quorum_verification
        );
        assert_eq!(
            signed_remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint_json_schema(
            )["additionalProperties"],
            false
        );
        assert_eq!(
        ...
        let final_witness_a_trust = new_remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint_witness_trust_state(
            "checkpoint-receipt-quorum-witness-a",
            &final_witness_a_key.verifying_key().to_bytes(),
        )
        .unwrap();
        let final_witness_b_trust = new_remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint_witness_trust_state(
            "checkpoint-receipt-quorum-witness-b",
            &final_witness_b_key.verifying_key().to_bytes(),
        )
        .unwrap();
        let final_trust_source = render_remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint_witness_trust_state(
            &final_witness_a_trust,
        )
        .unwrap();
        assert_eq!(
            parse_remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint_witness_trust_state(
                &final_trust_source,
            )
            .unwrap(),
            final_witness_a_trust
        );
        let final_trust_quorum = verify_remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint_witnesses_with_trust_states(
            &admission_report,
            &admission_log,
            &checkpoint_witness_receipt_quorum_checkpoint,
            &checkpoint_key.verifying_key().to_bytes(),
            &[final_witness_b.clone(), final_witness_a.clone()],
            &[final_witness_b_trust.clone(), final_witness_a_trust.clone()],
            2,
            1_400,
        )
        .unwrap();
        assert_eq!(final_trust_quorum, final_witness_quorum);

        let final_witness_a_next_key = SigningKey::from_bytes(&[106; 32]);
        let final_witness_a_last_key = SigningKey::from_bytes(&[107; 32]);
        let final_rotation_a1 = sign_remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint_witness_key_rotation(
            &final_witness_a_trust,
            &final_witness_a_key.to_bytes(),
            &final_witness_a_next_key.to_bytes(),
            1_250,
        )
        .unwrap();
        let final_rotation_source = render_signed_remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint_witness_key_rotation(
            &final_rotation_a1,
        )
        .unwrap();
        assert_eq!(
            parse_signed_remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint_witness_key_rotation(
                &final_rotation_source,
            )
            .unwrap(),
            final_rotation_a1
        );
        let final_witness_a_trust_1 = apply_remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint_witness_key_rotation(
            &final_witness_a_trust,
            &final_rotation_a1,
        )
        .unwrap();
        let final_rotation_a2 = sign_remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint_witness_key_rotation(
            &final_witness_a_trust_1,
            &final_witness_a_next_key.to_bytes(),
            &final_witness_a_last_key.to_bytes(),
            1_251,
        )
        .unwrap();
        let final_witness_a_trust_2 = apply_remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint_witness_key_rotation(
            &final_witness_a_trust_1,
            &final_rotation_a2,
        )
        .unwrap();
        assert_eq!(final_witness_a_trust_2.generation, 2);
        assert_eq!(
            final_rotation_a2.previous_rotation_sha256,
            final_witness_a_trust_1.last_rotation_sha256
        );
        let final_witness_a_rotated = sign_remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint_witness(
            &admission_report,
            &admission_log,
            &checkpoint_witness_receipt_quorum_checkpoint,
            &checkpoint_key.verifying_key().to_bytes(),
        ...
        .unwrap();
        let rotated_final_quorum = verify_remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint_witnesses_with_trust_states(
            &admission_report,
            &admission_log,
            &checkpoint_witness_receipt_quorum_checkpoint,
            &checkpoint_key.verifying_key().to_bytes(),
            &[final_witness_a_rotated.clone(), final_witness_b.clone()],
            &[final_witness_a_trust_2.clone(), final_witness_b_trust.clone()],
            2,
            1_400,
        )
        .unwrap();
        assert!(rotated_final_quorum.quorum_met);
        assert!(
            verify_remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint_witnesses_with_trust_states(
                &admission_report,
                &admission_log,
                &checkpoint_witness_receipt_quorum_checkpoint,
                &checkpoint_key.verifying_key().to_bytes(),
                std::slice::from_ref(&final_witness_a),
                std::slice::from_ref(&final_witness_a_trust_2),
                2,
                1_400,
            )
            .is_err()
        ...
        assert!(
            verify_remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint_witnesses_with_trust_states(
                ...
                &checkpoint_witness_receipt_quorum_checkpoint,
                &checkpoint_key.verifying_key().to_bytes(),
                std::slice::from_ref(&final_witness_a_rotated),
                std::slice::from_ref(&final_witness_a_trust),
                2,
                1_400,
            )
            .is_err()
        );
        let mut mismatched_final_trust = final_witness_b_trust.clone();
        mismatched_final_trust.witness_id = "different-final-witness".into();
        assert!(
            verify_remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint_witnesses_with_trust_states(
                &admission_report,
                &admission_log,
                &checkpoint_witness_receipt_quorum_checkpoint,
                &checkpoint_key.verifying_key().to_bytes(),
                std::slice::from_ref(&final_witness_b),
                &[mismatched_final_trust],
                2,
                1_400,
            )
            .is_err()
        );
        let final_trust_below_threshold = verify_remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint_witnesses_with_trust_states(
            &admission_report,
            &admission_log,
            &checkpoint_witness_receipt_quorum_checkpoint,
            &checkpoint_key.verifying_key().to_bytes(),
        ...
        .unwrap();
        assert!(!final_trust_below_threshold.quorum_met);
        assert_eq!(
            remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint_witness_trust_state_json_schema(
            )["additionalProperties"],
            false
        );
        assert_eq!(
            signed_remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint_witness_key_rotation_json_schema(
            )["additionalProperties"],
            false
        );

        let mut tampered_final_rotation = final_rotation_a1.clone();
        tampered_final_rotation
            .new_signature
            .replace_range(..2, "00");
        assert!(
            validate_signed_remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint_witness_key_rotation(
        ...
        let mut wrong_domain_final_rotation = final_rotation_a1.clone();
        let mut wrong_domain_final_rotation_payload =
            factory_checkpoint_witness_receipt_quorum_log_checkpoint_witness_key_rotation_payload(
                &wrong_domain_final_rotation,
            )
            .unwrap();
        wrong_domain_final_rotation_payload.splice(
            ..CHECKPOINT_WITNESS_RECEIPT_QUORUM_LOG_CHECKPOINT_WITNESS_KEY_ROTATION_DOMAIN.len(),
            RECEIPT_QUORUM_LOG_CHECKPOINT_WITNESS_KEY_ROTATION_DOMAIN
                .as_bytes()
                .iter()
                .copied(),
        );
        wrong_domain_final_rotation.old_signature = hex::encode(
            final_witness_a_key
                .sign(&wrong_domain_final_rotation_payload)
                .to_bytes(),
        );
        wrong_domain_final_rotation.new_signature = hex::encode(
            final_witness_a_next_key
                .sign(&wrong_domain_final_rotation_payload)
                .to_bytes(),
        );
        assert!(
        ...
        let mut skipped_final_rotation = final_rotation_a1.clone();
        skipped_final_rotation.to_generation = 2;
        assert!(
            validate_signed_remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint_witness_key_rotation(
                &skipped_final_rotation,
            )
            .is_err()
        );
        let mut missing_final_predecessor = final_rotation_a2.clone();
        missing_final_predecessor.previous_rotation_sha256 = None;
        assert!(
            validate_signed_remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint_witness_key_rotation(
                &missing_final_predecessor,
            )
            .is_err()
        );
        assert!(
        ...
        assert!(
            new_remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint_witness_trust_state(
                "weak-final-witness",
                &[0; 32],
            )
            .is_err()
        );
        let mut final_checkpoint_role_witness = final_witness_a.clone();
        final_checkpoint_role_witness.witness_id = "final-checkpoint-signer-reused".into();
        final_checkpoint_role_witness.public_key =
            hex::encode(checkpoint_key.verifying_key().to_bytes());
        final_checkpoint_role_witness.signature = hex::encode(
            checkpoint_key
                .sign(
                    &factory_checkpoint_witness_receipt_quorum_log_checkpoint_witness_payload(
                        &final_checkpoint_role_witness,
                    )
                    .unwrap(),
                )
                .to_bytes(),
        );
        let final_checkpoint_role_trust = new_remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint_witness_trust_state(
            "final-checkpoint-signer-reused",
            &checkpoint_key.verifying_key().to_bytes(),
        )
        .unwrap();
        assert!(
            verify_remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint_witnesses_with_trust_states(
                ...
                &checkpoint_key.verifying_key().to_bytes(),
                &[final_checkpoint_role_witness],
                &[final_checkpoint_role_trust],
                2,
                1_400,
            )
            .is_err()
        );
        let exhausted_final_trust = RemoteFactoryReleaseRegistryHistoryReceiptQuorumLogCheckpointWitnessReceiptQuorumLogCheckpointWitnessTrustState {
            schema_version: 1,
            witness_id: "checkpoint-receipt-quorum-witness-a".into(),
            generation: MAX_FACTORY_RELEASE_STATE_TRANSPARENCY_EXTERNAL_GOSSIP_REGISTRY_GENERATION,
            current_public_key: hex::encode(final_witness_a_last_key.verifying_key().to_bytes()),
            last_rotation_sha256: Some("a".repeat(64)),
            last_rotated_at_unix: Some(1_251),
        };
        assert!(
            sign_remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint_witness_key_rotation(
                &exhausted_final_trust,
                &final_witness_a_last_key.to_bytes(),
                &SigningKey::from_bytes(&[108; 32]).to_bytes(),
                1_252,
            )
            .is_err()
        );
        ...
        cross_domain_checkpoint.signature = checkpoint.signature.clone();
        assert!(
            verify_remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint(
                &admission_report,
                &admission_log,
                &cross_domain_checkpoint,
                &checkpoint_key.verifying_key().to_bytes(),
            )
            .is_err()
        );
        let mut substituted_checkpoint = checkpoint_witness_receipt_quorum_checkpoint.clone();
        substituted_checkpoint.receipt_quorum_checkpoint_sha256 = "d".repeat(64);
        assert!(
            verify_remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint(
                &admission_report,
                &admission_log,
