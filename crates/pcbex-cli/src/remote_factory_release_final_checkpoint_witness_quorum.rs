//! Parallel acquisition of a final factory checkpoint witness quorum.
//!
//! This boundary preserves the v1.512 report, v1.514 checkpoint, and v1.515
//! witness/quorum wire contracts. It validates every endpoint and trust input,
...
//! unchanged v1.515 witnesses through the v1.517 adapter. Successful responses
//! and credential-free receipts are retained alongside coarse failure classes,
//! and the production v1.515 verifier constructs the final quorum.
...
use crate::remote_factory_release_state_transparency_external_gossip_registry_checkpoint_witness::{
    ...
    decode_hex, digest_schema, parse_canonical, parse_remote_receipt_quorum_approval_log,
    ...
    preflight_remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint_witness_request,
    ...
    render_bounded,
    render_remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint_witness_receipt,
    render_remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint_witness_trust_state,
    render_signed_remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint_witness,
    request_remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint_witness,
    request_remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint_witness_with_trust_state,
    sha256, signed_remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint_witness_json_schema,
    slug_schema, validate_digest, validate_endpoint, validate_env_name,
    ...
    validate_slug,
    verify_remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint_witness_receipt,
    verify_remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint_witness_receipt_with_trust_state,
...
const PROTOCOL: &str =
    "pcbex-remote-factory-release-final-checkpoint-witness-quorum-acquisition-v1";
...
pub(crate) const MAX_REMOTE_FACTORY_RELEASE_FINAL_CHECKPOINT_WITNESS_QUORUM_MANIFEST_BYTES: u64 =
    1024 * 1024;
pub(crate) const MAX_REMOTE_FACTORY_RELEASE_FINAL_CHECKPOINT_WITNESS_QUORUM_ACQUISITION_REPORT_BYTES:
    u64 = 16 * 1024 * 1024;

#[derive(Clone, Debug, Eq, PartialEq, Serialize, Deserialize)]
#[serde(deny_unknown_fields)]
pub(crate) struct RemoteFactoryReleaseFinalCheckpointWitnessQuorumManifestMember {
...
#[derive(Clone, Debug, Eq, PartialEq, Serialize, Deserialize)]
#[serde(deny_unknown_fields)]
pub(crate) struct RemoteFactoryReleaseFinalCheckpointWitnessQuorumManifest {
    pub(crate) schema_version: u32,
    pub(crate) minimum_witnesses: u32,
    pub(crate) maximum_parallelism: u32,
    pub(crate) members: Vec<RemoteFactoryReleaseFinalCheckpointWitnessQuorumManifestMember>,
}

#[derive(Clone, Copy, Debug, Eq, PartialEq, Serialize, Deserialize)]
#[serde(rename_all = "snake_case")]
pub(crate) enum RemoteFactoryReleaseFinalCheckpointWitnessAcquisitionStatus {
    Verified,
    Failed,
}
...
#[derive(Clone, Copy, Debug, Eq, PartialEq, Serialize, Deserialize)]
#[serde(rename_all = "snake_case")]
pub(crate) enum RemoteFactoryReleaseFinalCheckpointWitnessAcquisitionFailureCode {
    Credential,
    Transport,
    HttpStatus,
    ContentType,
...
#[derive(Clone, Debug, Eq, PartialEq, Serialize, Deserialize)]
#[serde(deny_unknown_fields)]
pub(crate) struct RemoteFactoryReleaseFinalCheckpointWitnessAcquisitionMember {
    pub(crate) endpoint: String,
    pub(crate) witness_id: String,
    ...
    pub(crate) status: RemoteFactoryReleaseFinalCheckpointWitnessAcquisitionStatus,
    pub(crate) failure_code:
        Option<RemoteFactoryReleaseFinalCheckpointWitnessAcquisitionFailureCode>,
...
#[derive(Clone, Debug, Eq, PartialEq, Serialize, Deserialize)]
#[serde(deny_unknown_fields)]
pub(crate) struct RemoteFactoryReleaseFinalCheckpointWitnessQuorumAcquisitionReport {
    pub(crate) schema_version: u32,
    ...
    pub(crate) members: Vec<RemoteFactoryReleaseFinalCheckpointWitnessAcquisitionMember>,
    pub(crate) quorum:
        RemoteFactoryReleaseRegistryHistoryReceiptQuorumLogCheckpointWitnessReceiptQuorumLogCheckpointWitnessQuorumReport,
    pub(crate) quorum_met: bool,
}

pub(crate) fn render_remote_factory_release_final_checkpoint_witness_quorum_manifest(
    manifest: &RemoteFactoryReleaseFinalCheckpointWitnessQuorumManifest,
) -> Result<Vec<u8>, String> {
    validate_manifest(manifest, true)?;
    render_bounded(
        manifest,
        MAX_REMOTE_FACTORY_RELEASE_FINAL_CHECKPOINT_WITNESS_QUORUM_MANIFEST_BYTES,
        "remote factory release final checkpoint witness quorum manifest",
    )
}

pub(crate) fn parse_remote_factory_release_final_checkpoint_witness_quorum_manifest(
    source: &[u8],
) -> Result<RemoteFactoryReleaseFinalCheckpointWitnessQuorumManifest, String> {
...
pub(crate) fn render_remote_factory_release_final_checkpoint_witness_quorum_acquisition_report(
    report: &RemoteFactoryReleaseFinalCheckpointWitnessQuorumAcquisitionReport,
) -> Result<Vec<u8>, String> {
...
pub(crate) fn parse_remote_factory_release_final_checkpoint_witness_quorum_acquisition_report(
    source: &[u8],
) -> Result<RemoteFactoryReleaseFinalCheckpointWitnessQuorumAcquisitionReport, String> {
...
pub(crate) fn request_remote_factory_release_final_checkpoint_witness_quorum(
    manifest_source: &[u8],
    ...
    (
        RemoteFactoryReleaseFinalCheckpointWitnessQuorumAcquisitionReport,
        RemoteFactoryReleaseRegistryHistoryReceiptQuorumLogCheckpointWitnessReceiptQuorumLogCheckpointWitnessQuorumReport,
    ),
    String,
>{
    let manifest =
        parse_remote_factory_release_final_checkpoint_witness_quorum_manifest(manifest_source)?;
    ...
    let semantic_report = parse_remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_report(
        quorum_report_source,
    )?;
    ...
    let quorum = verify_remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint_witnesses(
        &semantic_report,
        &admission_log,
        &checkpoint,
        trusted_checkpoint_public_key,
    ...
    let report = RemoteFactoryReleaseFinalCheckpointWitnessQuorumAcquisitionReport {
        schema_version: 1,
        protocol: PROTOCOL.into(),
        manifest_sha256: sha256(manifest_source),
        checkpoint_witness_receipt_quorum_report_source_sha256: sha256(quorum_report_source),
        admission_log_source_sha256: sha256(admission_log_source),
...
#[allow(clippy::too_many_arguments)]
pub(crate) fn verify_remote_factory_release_final_checkpoint_witness_quorum_acquisition_report(
    report: &RemoteFactoryReleaseFinalCheckpointWitnessQuorumAcquisitionReport,
    manifest_source: &[u8],
    quorum_report_source: &[u8],
    admission_log_source: &[u8],
...
>{
    ...
    if report.manifest_sha256 != sha256(manifest_source)
        ...
        || report.admission_log_source_sha256 != sha256(admission_log_source)
    ...
    for (configured, observed) in manifest.members.iter().zip(&report.members) {
        ...
        if observed.status == RemoteFactoryReleaseFinalCheckpointWitnessAcquisitionStatus::Verified
        {
            ...
            let response = render_signed_remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint_witness(
                witness,
            )?;
            let verified = if let Some(state) = &configured.witness_trust_state {
                let state_source = render_remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint_witness_trust_state(
                    state,
                )?;
                verify_remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint_witness_receipt_with_trust_state(
                    receipt,
...
#[allow(clippy::too_many_arguments)]
fn request_member(
    member: &RemoteFactoryReleaseFinalCheckpointWitnessQuorumManifestMember,
    quorum_report_source: &[u8],
    admission_log_source: &[u8],
    checkpoint_source: &[u8],
    trusted_checkpoint_public_key: &[u8; 32],
    evaluated_at_unix: u64,
    allow_http_loopback: bool,
) -> Result<RemoteFactoryReleaseFinalCheckpointWitnessAcquisitionMember, String> {
    ...
    let (status, failure_code, witness, receipt) = match result {
        Ok((witness, receipt)) if witness.witness_id == member.witness_id => (
            RemoteFactoryReleaseFinalCheckpointWitnessAcquisitionStatus::Verified,
            None,
            Some(witness),
            Some(receipt),
        ),
        Ok(_) => (
            RemoteFactoryReleaseFinalCheckpointWitnessAcquisitionStatus::Failed,
            Some(
                RemoteFactoryReleaseFinalCheckpointWitnessAcquisitionFailureCode::IdentityMismatch,
            ),
            None,
            None,
        ),
    ...
    Ok(
        RemoteFactoryReleaseFinalCheckpointWitnessAcquisitionMember {
...
fn classify_failure(
    error: &str,
) -> RemoteFactoryReleaseFinalCheckpointWitnessAcquisitionFailureCode {
    if error.contains("bearer-token environment") {
        RemoteFactoryReleaseFinalCheckpointWitnessAcquisitionFailureCode::Credential
    } else if error.contains("unexpected HTTP status") || error.contains("http status:") {
        RemoteFactoryReleaseFinalCheckpointWitnessAcquisitionFailureCode::HttpStatus
    } else if error.contains("HTTPS request failed") {
        RemoteFactoryReleaseFinalCheckpointWitnessAcquisitionFailureCode::Transport
    } else if error.contains("Content-Type") {
        RemoteFactoryReleaseFinalCheckpointWitnessAcquisitionFailureCode::ContentType
    } else if error.contains("response exceeds") || error.contains("reading bounded") {
        RemoteFactoryReleaseFinalCheckpointWitnessAcquisitionFailureCode::ResponseLimit
    } else if error.contains("invalid signed factory")
        || error.contains("not canonical pretty JSON")
        || error.contains("duplicate")
    {
        RemoteFactoryReleaseFinalCheckpointWitnessAcquisitionFailureCode::InvalidResponse
    } else {
        RemoteFactoryReleaseFinalCheckpointWitnessAcquisitionFailureCode::Verification
    }
}
...
fn member_key_and_binding(
    ...
    match (&member.witness_public_key, &member.witness_trust_state) {
        ...
        (None, Some(state)) => {
            ...
            let source = render_remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint_witness_trust_state(
                state,
            )?;
...
fn verified_witnesses_and_keys(
    members: &[RemoteFactoryReleaseFinalCheckpointWitnessAcquisitionMember],
) -> Result<
    (
        Vec<
            SignedRemoteFactoryReleaseRegistryHistoryReceiptQuorumLogCheckpointWitnessReceiptQuorumLogCheckpointWitness,
...
>{
    ...
    for member in members {
        if member.status == RemoteFactoryReleaseFinalCheckpointWitnessAcquisitionStatus::Verified {
            witnesses.push(
            ...
            RemoteFactoryReleaseFinalCheckpointWitnessAcquisitionStatus::Verified => {
                ...
                if witness.witness_id != member.witness_id
                    ...
                    || receipt.checkpoint_witness_receipt_quorum_report_source_sha256
                        != report.checkpoint_witness_receipt_quorum_report_source_sha256
                    || receipt.admission_log_source_sha256 != report.admission_log_source_sha256
...
pub(crate) fn remote_factory_release_final_checkpoint_witness_quorum_manifest_json_schema() -> Value
{
    json!({
        "$schema": "https://json-schema.org/draft/2020-12/schema",
        "$id": "https://github.com/penguin425/pcbex/schema/remote-factory-release-final-checkpoint-witness-quorum-manifest-v1.json",
        "title": "pcbex remote factory release final checkpoint witness quorum manifest",
        "type": "object",
                    ...
                    "oneOf": [
                        ...
                        },
                        {
                            "properties": {
                                ...
                                "witness_trust_state": remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint_witness_trust_state_json_schema()
                            }
                        }
                    ]
                }
...
pub(crate) fn remote_factory_release_final_checkpoint_witness_quorum_acquisition_report_json_schema()
-> Value {
    ...
    json!({
        "$schema": "https://json-schema.org/draft/2020-12/schema",
        "$id": "https://github.com/penguin425/pcbex/schema/remote-factory-release-final-checkpoint-witness-quorum-acquisition-report-v1.json",
        "title": "pcbex remote factory release final checkpoint witness quorum acquisition report",
        "type": "object",
        "additionalProperties": false,
        "required": [
            "schema_version", "protocol", "manifest_sha256",
            "checkpoint_witness_receipt_quorum_report_source_sha256",
            "admission_log_source_sha256", "checkpoint_source_sha256",
        ...
        "properties": {
            ...
            "checkpoint_witness_receipt_quorum_report_source_sha256": digest_schema(),
            "admission_log_source_sha256": digest_schema(),
            ...
            "quorum": remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint_witness_quorum_report_json_schema(),
...
mod tests {
    ...
    fn manifest() -> RemoteFactoryReleaseFinalCheckpointWitnessQuorumManifest {
        RemoteFactoryReleaseFinalCheckpointWitnessQuorumManifest {
            schema_version: 1,
            minimum_witnesses: 2,
            maximum_parallelism: 2,
            members: vec![
                RemoteFactoryReleaseFinalCheckpointWitnessQuorumManifestMember {
    ...
    fn closes_and_canonicalizes_bounded_parallel_witness_manifests() {
        ...
        let source =
            render_remote_factory_release_final_checkpoint_witness_quorum_manifest(&manifest)
                .unwrap();
        assert_eq!(
            parse_remote_factory_release_final_checkpoint_witness_quorum_manifest(&source).unwrap(),
            manifest
        );
        assert_eq!(
            remote_factory_release_final_checkpoint_witness_quorum_manifest_json_schema()["additionalProperties"],
            false
        );
        assert_eq!(
            remote_factory_release_final_checkpoint_witness_quorum_manifest_json_schema()["properties"]
                ["members"]["items"]["additionalProperties"],
            false
        );
        assert!(
            parse_remote_factory_release_final_checkpoint_witness_quorum_manifest(
        ...
        assert!(
            render_remote_factory_release_final_checkpoint_witness_quorum_manifest(&unordered)
                .is_err()
        );
        ...
        assert!(
            render_remote_factory_release_final_checkpoint_witness_quorum_manifest(&repeated_key)
                .is_err()
        );
        let mut serial = manifest.clone();
        serial.maximum_parallelism = 1;
        assert!(
            render_remote_factory_release_final_checkpoint_witness_quorum_manifest(&serial)
                .is_err()
        );
        assert!(
    ...
    fn partial_report() -> RemoteFactoryReleaseFinalCheckpointWitnessQuorumAcquisitionReport {
        let checkpoint_key = key(1);
        let witness_a_key = key(2);
        let witness_b_key = key(3);
        let witness = SignedRemoteFactoryReleaseRegistryHistoryReceiptQuorumLogCheckpointWitnessReceiptQuorumLogCheckpointWitness {
            schema_version: 1,
        ...
        let receipt = RemoteFactoryReleaseRegistryHistoryReceiptQuorumLogCheckpointWitnessReceiptQuorumLogCheckpointWitnessReceipt {
            schema_version: 1,
            adapter: "remote-factory-release-registry-receipt-quorum-log-checkpoint-witness-receipt-quorum-log-checkpoint-witness-https-v1".into(),
            endpoint: "https://witness-a.example/v1/final".into(),
            checkpoint_witness_receipt_quorum_report_sha256: "7".repeat(64),
            checkpoint_witness_receipt_quorum_report_source_sha256: "1".repeat(64),
            registry_id: "factory-registry".into(),
            generation: 5,
            ...
            admission_log_head_sha256: "5".repeat(64),
            admission_log_sha256: "6".repeat(64),
            admission_log_source_sha256: "2".repeat(64),
            checkpoint_sha256: "8".repeat(64),
        ...
        RemoteFactoryReleaseFinalCheckpointWitnessQuorumAcquisitionReport {
            ...
            members: vec![
                RemoteFactoryReleaseFinalCheckpointWitnessAcquisitionMember {
                    ...
                    witness_key_trust_state_sha256: None,
                    witness_key_generation: None,
                    status: RemoteFactoryReleaseFinalCheckpointWitnessAcquisitionStatus::Verified,
                    failure_code: None,
                ...
                RemoteFactoryReleaseFinalCheckpointWitnessAcquisitionMember {
                    ...
                    witness_key_trust_state_sha256: None,
                    witness_key_generation: None,
                    status: RemoteFactoryReleaseFinalCheckpointWitnessAcquisitionStatus::Failed,
                    failure_code: Some(
                        RemoteFactoryReleaseFinalCheckpointWitnessAcquisitionFailureCode::Transport,
                    ),
                    witness: None,
    ...
    fn retains_only_closed_verified_successes_and_coarse_partial_failures() {
        ...
        let source =
            render_remote_factory_release_final_checkpoint_witness_quorum_acquisition_report(
                &report,
            )
            .unwrap();
        assert_eq!(
            parse_remote_factory_release_final_checkpoint_witness_quorum_acquisition_report(
                &source
            )
            .unwrap(),
            report
        ...
        assert_eq!(
            remote_factory_release_final_checkpoint_witness_quorum_acquisition_report_json_schema()
