...
fn tool_definitions(tasks_supported: bool) -> Vec<Value> {
    vec![
        ...
        tool(
            ...
            "Verify and append final checkpoint-witness receipt",
            "Replay the exact checkpoint-witness receipt quorum report, complete admission log, signed final checkpoint, raw witness response, checkpoint trust, final-witness trust, freshness, and Ed25519 signatures before appending one unchanged receipt event.",
            json!({
                "type": "object", "additionalProperties": false,
                "required": [
                    "log", "receipt", "quorum_report", "approval_log", "checkpoint",
        ...
        tool(
            ...
            "Verify and append final checkpoint-witness receipt quorum",
            "Replay one exact checkpoint-witness receipt quorum report, complete admission log, signed final checkpoint, raw witness responses, checkpoint trust, per-witness trust, freshness, and Ed25519 signatures before no-clobber publication of the admitted final receipt quorum and report.",
            json!({
                "type": "object", "additionalProperties": false,
                "required": [
        ...
        tool(
            ...
            "Verify and append final receipt-quorum checkpoint-witness receipt quorum",
            "Replay the shared v1.521 report, complete final admission log, signed v1.523 checkpoint, exact v1.524 responses, checkpoint trust, per-witness trust, freshness, and Ed25519 signatures once before no-clobber publication of the sorted v1.528 event quorum and its bound report.",
            json!({
                "type": "object", "additionalProperties": false,
                "required": [
                    "log", "receipts", "quorum_report", "approval_log",
        ...
        tool(
            ...
            "Verify and append final receipt-quorum checkpoint-witness receipt",
            "Replay the exact final receipt-admission quorum report, complete final admission log, signed receipt-quorum checkpoint, raw witness response, independently pinned checkpoint trust, expected final-witness identity and trust, and admission-time freshness before appending the unchanged v1.528 event.",
            json!({
                "type": "object", "additionalProperties": false,
                "required": [
                    "log", "receipt", "quorum_report", "approval_log", "checkpoint",
                    "checkpoint_public_key", "response", "witness_id", "output"
                ],
                "properties": {
                    "log": {"type": "string"},
                    "receipt": {"type": "string"},
        ...
        tool(
            ...
            "Sign quorum-bound factory final checkpoint-witness receipt log",
            "Create an Ed25519 checkpoint only when the exact log and its final checkpoint-witness receipt suffix match a successful verifier-bound final receipt quorum report.",
            json!({
                "type": "object", "additionalProperties": false,
                "required": ["log", "quorum_report", "private_key", "signer_id", "output"],
                "properties": {
        ...
        tool(
            ...
            "Sign dedicated factory final checkpoint-witness receipt-quorum checkpoint",
            "Domain-separate and sign the exact verifier-bound final checkpoint-witness receipt-quorum report digest, both prior checkpoints, and final admission-log state.",
            json!({
                "type": "object", "additionalProperties": false,
                "required": ["log", "quorum_report", "private_key", "signer_id", "output"],
                "properties": {
        ...
        tool(
            ...
            "Verify dedicated factory final checkpoint-witness receipt-quorum checkpoint",
            "Verify the final checkpoint-witness receipt-quorum signature against the exact report, final admission log, and trusted public key.",
            json!({
                "type": "object", "additionalProperties": false,
        ...
        tool(
            ...
            "Re-verify the exact dedicated checkpoint evidence and require a fresh quorum against either direct key pins or current generation-chained witness trust states.",
            json!({
                "type": "object", "additionalProperties": false,
                "required": [
                    "log", "quorum_report", "checkpoint", "checkpoint_public_key",
        ...
        tool(
            ...
            "Initialize factory checkpoint-witness receipt-quorum checkpoint witness trust",
            "Pin generation-zero trust for one factory checkpoint-witness receipt-quorum checkpoint witness identity and Ed25519 public key.",
            json!({
                "type": "object", "additionalProperties": false,
                "required": ["witness_id", "public_key", "output"],
                "properties": {
        ...
        tool(
            ...
            "Sign factory checkpoint-witness receipt-quorum checkpoint witness key rotation",
            "Require old-key authorization and new-key possession for one generation-chained factory checkpoint witness trust transition.",
            json!({
                "type": "object", "additionalProperties": false,
                "required": [
                    "trust_state", "old_private_key", "new_private_key", "output"
        ...
        tool(
            ...
            "Apply factory checkpoint-witness receipt-quorum checkpoint witness key rotation",
            "Verify and atomically advance retained factory checkpoint witness trust by exactly one generation.",
            json!({
                "type": "object", "additionalProperties": false,
                "required": ["trust_state", "rotation", "output"],
                "properties": {
        ...
        tool(
            ...
            "Export factory checkpoint-witness receipt-quorum checkpoint witness public key",
            "Validate retained factory checkpoint witness trust and export its currently trusted Ed25519 public key.",
            json!({
                "type": "object", "additionalProperties": false,
                "required": ["trust_state", "output"],
                "properties": {
...
fn append_verified_remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint_witness_receipt(
    arguments: Map<String, Value>,
    cancellation: Option<&AtomicBool>,
) -> std::result::Result<Value, Value> {
    reject_unknown(
...
fn append_verified_remote_factory_release_final_checkpoint_witness_receipt_quorum_log_checkpoint_witness_receipt(
    arguments: Map<String, Value>,
    cancellation: Option<&AtomicBool>,
) -> std::result::Result<Value, Value> {
    reject_unknown(
...
fn append_verified_remote_factory_release_final_checkpoint_witness_receipt_quorum_log_checkpoint_witness_receipt_quorum(
    arguments: Map<String, Value>,
    cancellation: Option<&AtomicBool>,
) -> std::result::Result<Value, Value> {
    reject_unknown(
    ...
    let mut command = vec![
        "append-verified-remote-factory-release-final-checkpoint-witness-receipt-quorum-log-checkpoint-witness-receipt-quorum"
            .into(),
        required_string(&arguments, "log")?,
    ];
...
fn append_verified_remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint_witness_receipt_quorum(
    arguments: Map<String, Value>,
    cancellation: Option<&AtomicBool>,
) -> std::result::Result<Value, Value> {
    reject_unknown(
...
fn sign_quorum_bound_factory_final_checkpoint_witness_receipt_transparency_log(
    arguments: Map<String, Value>,
    cancellation: Option<&AtomicBool>,
) -> std::result::Result<Value, Value> {
    reject_unknown(
    ...
    let output = required_string(&arguments, "output")?;
    let command = vec![
        "sign-approval-log-with-remote-factory-release-registry-history-receipt-quorum-log-checkpoint-witness-receipt-quorum-log-checkpoint-witness-receipt-quorum"
            .into(),
        required_string(&arguments, "log")?,
        "--quorum-report".into(),
        required_string(&arguments, "quorum_report")?,
...
fn sign_remote_factory_release_final_checkpoint_witness_receipt_quorum_log_checkpoint(
    arguments: Map<String, Value>,
    cancellation: Option<&AtomicBool>,
) -> std::result::Result<Value, Value> {
    reject_unknown(
    ...
    let output = required_string(&arguments, "output")?;
    let command = vec![
        "sign-remote-factory-release-final-checkpoint-witness-receipt-quorum-log-checkpoint".into(),
        required_string(&arguments, "log")?,
        "--quorum-report".into(),
        required_string(&arguments, "quorum_report")?,
        "--private-key".into(),
...
fn verify_remote_factory_release_final_checkpoint_witness_receipt_quorum_log_checkpoint(
    arguments: Map<String, Value>,
    cancellation: Option<&AtomicBool>,
) -> std::result::Result<Value, Value> {
    reject_unknown(
    ...
    let output = required_string(&arguments, "output")?;
    let command = vec![
        "verify-remote-factory-release-final-checkpoint-witness-receipt-quorum-log-checkpoint"
            .into(),
        required_string(&arguments, "log")?,
        "--quorum-report".into(),
        required_string(&arguments, "quorum_report")?,
...
fn verify_remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint_witnesses(
    ...
    {
        return Err(json!({
            "detail": "use either factory checkpoint-witness receipt quorum checkpoint witness public keys or trust states"
        }));
    }
    let trust_count = if trust_states.is_empty() {
        public_keys.len()
    ...
    if witnesses.len() != trust_count {
        return Err(json!({
            "detail": "factory checkpoint-witness receipt quorum checkpoint witnesses and trust inputs must be paired"
        }));
    }
    let output = required_string(&arguments, "output")?;
    let mut command = vec![
...
fn init_remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint_witness_trust(
    arguments: Map<String, Value>,
    cancellation: Option<&AtomicBool>,
) -> std::result::Result<Value, Value> {
    reject_unknown(&arguments, &["witness_id", "public_key", "output"])?;
...
fn sign_remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint_witness_key_rotation(
    arguments: Map<String, Value>,
    cancellation: Option<&AtomicBool>,
) -> std::result::Result<Value, Value> {
    reject_unknown(
...
fn apply_remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint_witness_key_rotation(
    arguments: Map<String, Value>,
    cancellation: Option<&AtomicBool>,
) -> std::result::Result<Value, Value> {
    reject_unknown(&arguments, &["trust_state", "rotation", "output"])?;
...
fn export_remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint_witness_public_key(
    arguments: Map<String, Value>,
    cancellation: Option<&AtomicBool>,
) -> std::result::Result<Value, Value> {
    reject_unknown(&arguments, &["trust_state", "output"])?;
...
mod tests {
    ...
    #[test]
    fn final_factory_checkpoint_witness_quorum_requires_one_trust_mode() {
        let base = json!({
            "log": "log.json",
        ...
        let mut absent = base.as_object().unwrap().clone();
        let absent_error = verify_remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint_witnesses(
        ...
        assert_eq!(
            absent_error["detail"],
            "use either factory checkpoint-witness receipt quorum checkpoint witness public keys or trust states"
        );
        ...
        let mixed_error = verify_remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint_witnesses(
            mixed,
            None,
        )
        .unwrap_err();
        ...
        let unpaired_error = verify_remote_factory_release_registry_history_receipt_quorum_log_checkpoint_witness_receipt_quorum_log_checkpoint_witnesses(
            unpaired,
            None,
        )
        .unwrap_err();
        assert_eq!(
            ...
            "factory checkpoint-witness receipt quorum checkpoint witnesses and trust inputs must be paired"
        );
    }
    ...
    fn negotiates_lifecycle_and_lists_tools() {
        ...
        assert_eq!(
            named("sign_quorum_bound_factory_final_checkpoint_witness_receipt_transparency_log")["inputSchema"]
                ["required"],
            json!(["log", "quorum_report", "private_key", "signer_id", "output"])
        );
        assert_eq!(
            named("sign_quorum_bound_factory_final_checkpoint_witness_receipt_transparency_log")["execution"]
                ["taskSupport"],
            "forbidden"
        );
        assert_eq!(
            named("sign_quorum_bound_factory_final_checkpoint_witness_receipt_transparency_log")["annotations"]
                ["destructiveHint"],
            true
        );
        assert_eq!(
    ...
    #[test]
    fn final_checkpoint_receipt_admission_quorum_rejects_partial_direct_trust_first() {
        let arguments = json!({
            "log": "log.json",
            "receipts": ["receipt.json"],
            "quorum_report": "quorum-report.json",
        ...
        let error = append_verified_remote_factory_release_final_checkpoint_witness_receipt_quorum_log_checkpoint_witness_receipt_quorum(
            arguments,
            None,
        )
        .unwrap_err();
    ...
    #[test]
    fn final_receipt_admission_requires_exactly_one_witness_trust_source() {
        ...
        let absent = append_verified_remote_factory_release_final_checkpoint_witness_receipt_quorum_log_checkpoint_witness_receipt(
            arguments.clone(),
            None,
        )
        .unwrap_err();
        assert_eq!(
            absent["detail"],
            "exactly one of witness_public_key or witness_trust_state is required"
        );

        arguments.insert("witness_public_key".into(), json!("witness.pub"));
        arguments.insert("witness_trust_state".into(), json!("witness.trust.json"));
        let mixed = append_verified_remote_factory_release_final_checkpoint_witness_receipt_quorum_log_checkpoint_witness_receipt(
            arguments,
            None,
        )
        .unwrap_err();
