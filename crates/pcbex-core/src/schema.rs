        ...
        "$defs": {
            ...
            "stackup_layer": {
                ...
                "properties": {
                    ...
                    "secondary_reference_layer": {"type": ["string", "null"]},
                    "secondary_dielectric_height_nm": {"type": ["integer", "null"], "exclusiveMinimum": 0},
                    "secondary_dielectric_constant": {"type": ["number", "null"], "exclusiveMinimum": 1}
                }
            }
        }
    })
